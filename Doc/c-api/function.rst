...
.. c:function:: PyObject* PyFunction_New(PyObject *code, PyObject *globals)
   ...
   The function's docstring and name are retrieved kutoka the code object. *__module__*
   is retrieved kutoka *globals*. The argument defaults, annotations and closure are
