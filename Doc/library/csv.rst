...
.. module:: csv
   :synopsis: Write and read tabular data to and kutoka delimited files.
...
The so-called CSV (Comma Separated Values) format is the most common agiza and
...
differences can make it annoying to process CSV files kutoka multiple sources.
...
data kutoka the programmer.

The :mod:`csv` module implements classes to read and write tabular data in CSV
format.  It allows programmers to say, "write this data in the format preferred
by Excel," or "read data kutoka this file which was generated by Excel," without
...
.. function:: reader(csvfile, dialect='excel', **fmtparams)
   ...
   *dialect* parameter can be given which is used to define a set of parameters
   specific to a particular CSV dialect.  It may be an instance of a subkundi of
   the :class:`Dialect` kundi or one of the strings returned by the
   :func:`list_dialects` function.  The other optional *fmtparams* keyword arguments
   can be given to override individual formatting parameters in the current
   dialect.  For full details about the dialect and formatting parameters, see
   section :ref:`csv-fmt-params`.

   Each row read kutoka the csv file is returned as a list of strings.  No
...
.. function:: writer(csvfile, dialect='excel', **fmtparams)
   ...
   particular CSV dialect.  It may be an instance of a subkundi of the
   :class:`Dialect` kundi or one of the strings returned by the
   :func:`list_dialects` function.  The other optional *fmtparams* keyword arguments
   can be given to override individual formatting parameters in the current
   dialect.  For full details about the dialect and formatting parameters, see
   ...
   CSV files without preprocessing the data returned kutoka a ``cursor.fetch*`` call.
...
.. function:: register_dialect(name[, dialect[, **fmtparams]])
   ...
   dialect can be specified either by passing a sub-kundi of :class:`Dialect`, or
...
.. function:: unregister_dialect(name)
   ...
   Delete the dialect associated with *name* kutoka the dialect registry.  An
...
.. class:: DictWriter(f, fieldnames, restval='', extrasaction='raise', \
   ...
   *fieldnames*, the optional *extrasaction* parameter indicates what action to
   ...
   of the :class:`DictWriter` kundi is not optional.
...
.. class:: Dialect
   ...
   The :class:`Dialect` kundi is a container kundi relied on primarily for its
...
.. class:: excel()
   ...
   The :class:`excel` kundi defines the usual properties of an Excel-generated CSV
   file.  It is registered with the dialect name ``'excel'``.


.. class:: excel_tab()

   The :class:`excel_tab` kundi defines the usual properties of an Excel-generated
   TAB-delimited file.  It is registered with the dialect name ``'excel-tab'``.


.. class:: unix_dialect()

   The :class:`unix_dialect` kundi defines the usual properties of a CSV file
...
.. class:: Sniffer()
   ...
   The :class:`Sniffer` kundi is used to deduce the format of a CSV file.

   The :class:`Sniffer` kundi provides two methods:
...
subkundi of the :class:`Dialect` kundi having a set of specific methods and a
single :meth:`validate` method.  When creating :class:`reader` or
:class:`writer` objects, the programmer can specify a string or a subkundi of
the :class:`Dialect` kundi as the dialect parameter.  In addition to, or instead
...
.. attribute:: Dialect.escapechar
   ...
   :const:`False`. On reading, the *escapechar* removes any special meaning kutoka
...
.. method:: csvreader.__next__()
   ...
   was returned kutoka :func:`reader`) or a dict (if it is a :class:`DictReader`
...
.. attribute:: csvreader.line_num
   ...
   The number of lines read kutoka the source iterator. This is not the same as the
...
.. attribute:: csvreader.fieldnames
   ...
   initialized upon first access or when the first record is read kutoka the
   file.
