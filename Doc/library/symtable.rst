...
Symbol tables are generated by the compiler kutoka AST just before bytecode is
...
.. class:: SymbolTable
   ...
   .. method:: get_name()
      ...
      Return the table's name.  This is the name of the kundi if the table is
   ...
   .. method:: is_nested()
      ...
      Return ``True`` if the block is a nested kundi or function.
...
.. class:: Function
   ...
   A namespace for a function or method.  This kundi inherits
   :class:`SymbolTable`.
...
.. class:: Class
   ...
   A namespace of a class.  This kundi inherits :class:`SymbolTable`.
...
.. class:: Symbol
   ...
   .. method:: is_imported()
      ...
      Return ``True`` if the symbol is created kutoka an agiza statement.
   ...
   .. method:: is_namespace()
      ...
      If the name is used as the target of a function or kundi statement, this
      will be true.
