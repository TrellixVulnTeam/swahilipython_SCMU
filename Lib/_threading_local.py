...
What's agizaant about thread-local objects is that their data are
...
# with circular agizas.  For that reason, we don't agiza `threading`
# until the bottom of this file (a hack sufficient to worm around the
# potential problems).  Note that all platforms on CPython do have support
# for locals in the `thread` module, and there is no circular agiza problem
