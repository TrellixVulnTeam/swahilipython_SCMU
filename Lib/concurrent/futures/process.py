...
- reads _ResultItems kutoka "Result Q", updates the future stored in the
  "Work Items" dict and deletes the dict entry

Process #1..n:
- reads _CallItems kutoka "Call Q", executes the calls, and puts the resulting
...
def _add_call_item_to_queue(pending_work_items,
    ...
    Args:
        ...
        work_ids: A queue.Queue of work ids e.g. Queue([5, 6, ...]). Work ids
            are consumed and the corresponding _WorkItems kutoka
...
def _queue_management_worker(executor_reference,
    ...
    Args:
        ...
        call_queue: A ctx.Queue that will be filled with _CallItems
            derived kutoka _WorkItems for processing by the process workers.
        result_queue: A ctx.SimpleQueue of _ResultItems generated by the
            process workers.
        thread_wakeup: A _ThreadWakeup to allow waking up the
            queue_manager_thread kutoka the main Thread and avoid deadlocks
    ...
    while True:
        ...
        # submitted, kutoka the executor being shutdown/gc-ed, or kutoka the
