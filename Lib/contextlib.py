...
kundi ContextDecorator(object):
    "A base kundi or mixin that enables context managers to work as decorators."
...
kundi _GeneratorContextManager(_GeneratorContextManagerBase,
    ...
    eleza __enter__(self):
        # do sio keep args and kwds alive unnecessarily
        ...
        tatizo StopIteration:
            raise RuntimeError("generator didn't yield") kutoka None
    ...
    eleza __exit__(self, type, value, traceback):
        ...
        isipokua:
            ...
            tatizo RuntimeError as exc:
                ...
                #
                # This cannot use 'tatizo BaseException as exc' (as in the
...
kundi _AsyncGeneratorContextManager(_GeneratorContextManagerBase,
    ...
    async eleza __aexit__(self, typ, value, traceback):
        ...
        isipokua:
            ...
            tatizo StopAsyncIteration as exc:
                rudisha exc ni sio value
            tatizo RuntimeError as exc:
                if exc is value:
                    rudisha False
...
kundi suppress(AbstractContextManager):
    ...
    eleza __exit__(self, exctype, excinst, exctb):
        ...
        # the instance and subkundi checking hooks). While Guido considers
        ...
        rudisha exctype ni sio None and issubclass(exctype, self._exceptions)


kundi _BaseExitStack:
    """A base kundi for ExitStack and AsyncExitStack."""
    ...
    eleza _push_exit_callback(self, callback, is_sync=True):
...
kundi ExitStack(_BaseExitStack, AbstractContextManager):
    ...
    eleza __exit__(self, *exc_details):
        received_exc = exc_details[0] ni sio None
        ...
        if pending_raise:
            ...
            tatizo BaseException:
                ...
                raise
        rudisha received_exc and suppressed_exc
...
kundi nullcontext(AbstractContextManager):
    ...
    eleza __init__(self, enter_result=None):
