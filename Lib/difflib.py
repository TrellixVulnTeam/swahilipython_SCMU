...
kundi SequenceMatcher:
    ...
    def get_opcodes(self):
        ...
        has i1 == j1 == 0, and remaining tuples have i1 == the i2 kutoka the
...
kundi Differ:
    ...
    ending with newlines (such sequences can also be obtained kutoka the
    ...
    def _fancy_replace(self, a, alo, ahi, b, blo, bhi):
        ...
        if best_ratio < cutoff:
            ...
            if eqi is None:
                ...
                yield kutoka self._plain_replace(a, alo, ahi, b, blo, bhi)
                return
        ...
        yield kutoka self._fancy_helper(a, alo, best_i, b, blo, best_j)
        ...
        yield kutoka self._fancy_helper(a, best_i+1, ahi, b, best_j+1, bhi)
...
def unified_diff(a, b, kutokafile='', tofile='', kutokafiledate='',
    ...
    created kutoka file.readlines() result in diffs that are suitable for
...
def _mdiff(kutokalines, tolines, context=None, linejunk=None,
    ...
    kutoka/to line tuple -- (line num, line text)
    ...
    def _make_line(lines, format_key, side, num_lines=[0,0]):
        ...
        lines -- list of lines kutoka the ndiff generator to produce a line of
                 text kutoka.  When producing the line of text to return, the
        ...
        side -- indice into the num_lines list (0=kutoka,1=to)
        num_lines -- kutoka/to current line number.  This is NOT intended to be a
    ...
    def _line_iterator():
        ...
        This function is an iterator.  It itself pulls lines kutoka a
        differencing iterator, processes them and yields them.  When it can
        it yields both a "kutoka" and a "to" line, otherwise it will yield one
        or the other.  In addition to yielding the lines of kutoka/to text, a
    ...
    def _line_pair_iterator():
        ...
        This function is an iterator.  It itself pulls lines kutoka the line
        iterator.  Its difference kutoka that iterator is that this function
        always yields a pair of kutoka/to text lines (with the change
...
kundi HtmlDiff(object):
    ...
    def _collect_lines(self,diffs):
        ...
        Before storing the mdiff kutoka/to data into a list, it is converted
    ...
    def _format_line(self,side,flag,linenum,text):
        ...
        side -- 0 or 1 indicating "kutoka" or "to" text
