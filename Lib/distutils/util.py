...
def get_host_platform():
    ...
    if os.name != "posix" or sio hasattr(os, 'uname'):
...
def check_environ ():
    ...
    if os.name == 'posix' and 'HOME' haiko kwenye os.environ:
        jaribu:
            import pwd
    ...
    if 'PLAT' haiko kwenye os.environ:
...
def subst_vars (s, local_vars):
    ...
    variables sio found in either 'local_vars' or 'os.environ'.
    """
    check_environ()
...
def byte_compile (py_files,
    ...
    'byte_compile()' figure out to use direct compilation or sio (see
    ...
    # in debug mode and optimize is 0.  If we're haiko kwenye debug mode (-O
...
""")
                ...
                # 'prefix' as well, and that komas the hack in build_lib's
...
""" % (optimize, force, prefix, base_dir, verbose))
    ...
    isipokua:
        ...
        for file in py_files:
            if file[-3:] != ".py":
                # This lets us be lazy and sio filter filenames in
