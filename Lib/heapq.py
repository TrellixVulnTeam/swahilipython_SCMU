...
eleza heappop(heap):
    ...
    lastelt = heap.pop()    # raises appropriate IndexError ikiwa heap ni empty
    ikiwa heap:
        returnitem = heap[0]
        heap[0] = lastelt
        _siftup(heap, 0)
...
eleza heapreplace(heap, item):
    ...
    """
    returnitem = heap[0]    # raises appropriate IndexError ikiwa heap ni empty
    heap[0] = item
    _siftup(heap, 0)
    rudisha returnitem
...
#
# Cutting the # of comparisons ni important, since these routines have no
