...
kundi HelpParser(HTMLParser):
    ...
    The behavior kila unsupported tags, such as table, ni undefined.
...
kundi HelpText(Text):
    ...
    eleza __init__(self, parent, filename):
        ...
        ukijumuisha open(filename, encoding='utf-8') as f:
            contents = f.read()
...
eleza copy_strip():
    ...
    As long as master na maintenance versions of idle.rst remain the
    ...
    ukijumuisha open(src, 'rb') as inn,\
         open(dst, 'wb') as out:
