...
agiza os
agiza sys
kutoka platform agiza python_version, architecture

kutoka tkinter agiza Toplevel, Frame, Label, Button, PhotoImage
kutoka tkinter agiza SUNKEN, TOP, BOTTOM, LEFT, X, BOTH, W, EW, NSEW, E
