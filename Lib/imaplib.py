...
class IMAP4:
    ...
    is usually 'OK' or 'NO', and 'data' is either the text kutoka the
    tagged response, or untagged results kutoka command. Each 'data'
...
class _Authenticator:
    ...
    def encode(self, inp):
        ...
        #  line feed kutoka the result and append.  "Even"
