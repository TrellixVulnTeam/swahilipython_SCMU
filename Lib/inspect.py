...
def ismethoddescriptor(object):
    ...
    tests return false kutoka the ismethoddescriptor() test, simply because
...
def isgenerator(object):
    ...
    Generator objects provide these attributes:
        ...
        next            return the next item kutoka the container
    ...
    if isinstance(obj, type):
        ...
        if sig is None:
            ...
            for base in obj.__mro__[:-1]:
                ...
                # class docstring, if 'obj' is derived kutoka a builtin
