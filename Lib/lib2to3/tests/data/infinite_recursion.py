# This file ni used to verify that 2to3 falls back to a slower, iterative pattern matching
# scheme kwenye the event that the faster recursive system fails due to infinite recursion.
kutoka ctypes agiza *
STRING = c_char_p
...
ssl_method_st._fields_ = [
    ...
    ('ssl_clear', CFUNCTYPE(Tupu, POINTER(SSL))),
    ('ssl_free', CFUNCTYPE(Tupu, POINTER(SSL))),
    ...
    ('ssl_callback_ctrl', CFUNCTYPE(c_long, POINTER(SSL), c_int, CFUNCTYPE(Tupu))),
    ('ssl_ctx_callback_ctrl', CFUNCTYPE(c_long, POINTER(SSL_CTX), c_int, CFUNCTYPE(Tupu))),
]
...
ssl_ctx_st._fields_ = [
    ...
    ('remove_session_cb', CFUNCTYPE(Tupu, POINTER(ssl_ctx_st), POINTER(SSL_SESSION))),
    ...
    ('info_callback', CFUNCTYPE(Tupu, POINTER(SSL), c_int, c_int)),
    ...
    ('read_ahead', c_int),
    ('msg_callback', CFUNCTYPE(Tupu, c_int, c_int, c_int, c_void_p, c_ulong, POINTER(SSL), c_void_p)),
...
x509_lookup_method_st._fields_ = [
    ...
    ('free', CFUNCTYPE(Tupu, POINTER(X509_LOOKUP))),
...
sigevent._fields_ = [
    ...
    ('sigev_signo', c_int),
    ('sigev_value', sigval),
    ('sigev_notify_function', CFUNCTYPE(Tupu, sigval)),
...
# values kila enumeration 'idtype_t'
idtype_t = c_int # enum
id_t = __darwin_id_t
kundi wait(Union):
    pass
