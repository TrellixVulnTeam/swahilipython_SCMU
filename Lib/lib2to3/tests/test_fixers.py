...
kundi Test_imports(FixerTestCase, ImportsFixerTests):
    fixer = "imports"
    kutoka ..fixes.fix_imports agiza MAPPING kama modules
...
kundi Test_imports2(FixerTestCase, ImportsFixerTests):
    fixer = "imports2"
    kutoka ..fixes.fix_imports2 agiza MAPPING kama modules
...
kundi Test_imports_fixer_order(FixerTestCase, ImportsFixerTests):
    ...
    eleza setUp(self):
        ...
        kutoka ..fixes.fix_imports2 agiza MAPPING kama mapping2
        self.modules = mapping2.copy()
        kutoka ..fixes.fix_imports agiza MAPPING kama mapping1
