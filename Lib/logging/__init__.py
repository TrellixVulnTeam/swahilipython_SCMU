...
#
#raiseExceptions ni used to see ikiwa exceptions during handling should be
#propagated
#
raiseExceptions = Kweli
...
kundi Logger(Filterer):
    ...
    eleza findCaller(self, stack_info=Uongo, stacklevel=1):
        ...
        """
        f = currentframe()
        #On some versions of IronPython, currentframe() returns Tupu if
...
eleza shutdown(handlerList=_handlerList):
    ...
    kila wr kwenye reversed(handlerList[:]):
        ...
        #we just ignore them ikiwa raiseExceptions ni sio set
        jaribu:
            h = wr()
            ikiwa h:
                jaribu:
