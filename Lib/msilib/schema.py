...
('AdminExecuteSequence','Condition','Y',Tupu, Tupu, Tupu, Tupu, 'Condition',Tupu, 'Optional expression which skips the action ikiwa evaluates to expUongo.If the expression syntax ni invalid, the engine will terminate, rudishaing iesBadActionData.',),
...
('AdminUISequence','Condition','Y',Tupu, Tupu, Tupu, Tupu, 'Condition',Tupu, 'Optional expression which skips the action ikiwa evaluates to expUongo.If the expression syntax ni invalid, the engine will terminate, rudishaing iesBadActionData.',),
...
('AdvtExecuteSequence','Condition','Y',Tupu, Tupu, Tupu, Tupu, 'Condition',Tupu, 'Optional expression which skips the action ikiwa evaluates to expUongo.If the expression syntax ni invalid, the engine will terminate, rudishaing iesBadActionData.',),
...
('AdvtUISequence','Condition','Y',Tupu, Tupu, Tupu, Tupu, 'Condition',Tupu, 'Optional expression which skips the action ikiwa evaluates to expUongo.If the expression syntax ni invalid, the engine will terminate, rudishaing iesBadActionData.',),
...
('AppSearch','Property','N',Tupu, Tupu, Tupu, Tupu, 'Identifier',Tupu, 'The property associated with a Signature',),
...
('File','Sequence','N',1,32767,Tupu, Tupu, Tupu, Tupu, 'Sequence with respect to the media images; order must track cabinet order.',),
('File','Attributes','Y',0,32767,Tupu, Tupu, Tupu, Tupu, 'Integer containing bit flags representing file attributes (with the decimal value of each bit position kwenye parentheses)',),
...
('CheckBox','Value','Y',Tupu, Tupu, Tupu, Tupu, 'Formatted',Tupu, 'The value string associated with the item.',),
...
('Class','Icon_','Y',Tupu, Tupu, 'Icon',1,'Identifier',Tupu, 'Optional foreign key into the Icon Table, specifying the icon file associated with this CLSID. Will be written under the DefaultIcon key.',),
('Class','IconIndex','Y',-32767,32767,Tupu, Tupu, Tupu, Tupu, 'Optional icon index.',),
('Class','ProgId_Default','Y',Tupu, Tupu, 'ProgId',1,'Text',Tupu, 'Optional ProgId associated with this CLSID.',),
('Component','Condition','Y',Tupu, Tupu, Tupu, Tupu, 'Condition',Tupu, "A conditional statement that will disable this component ikiwa the specified condition evaluates to the 'Kweli' state. If a component ni disabled, it will sio be installed, regardless of the 'Action' state associated with the component.",),
...
('Component','Directory_','N',Tupu, Tupu, 'Directory',1,'Identifier',Tupu, 'Required key of a Directory table record. This ni actually a property name whose value contains the actual path, set either by the AppSearch action ama with the default setting obtained kutoka the Directory table.',),
...
('ProgId','Icon_','Y',Tupu, Tupu, 'Icon',1,'Identifier',Tupu, 'Optional foreign key into the Icon Table, specifying the icon file associated with this ProgId. Will be written under the DefaultIcon key.',),
...
('ComboBox','Text','Y',Tupu, Tupu, Tupu, Tupu, 'Formatted',Tupu, 'The visible text to be assigned to the item. Optional. If this entry ama the entire column ni missing, the text ni the same kama the value.',),
...
('ComboBox','Value','N',Tupu, Tupu, Tupu, Tupu, 'Formatted',Tupu, 'The value string associated with this item. Selecting the line will set the associated property to this value.',),
...
('Directory','Directory_Parent','Y',Tupu, Tupu, 'Directory',1,'Identifier',Tupu, 'Reference to the entry kwenye this table specifying the default parent directory. A record parented to itself ama with a Null parent represents a root of the install tree.',),
...
('Control','Help','Y',Tupu, Tupu, Tupu, Tupu, 'Text',Tupu, 'The help strings used with the button. The text ni optional. ',),
...
('ControlEvent','Argument','N',Tupu, Tupu, Tupu, Tupu, 'Formatted',Tupu, 'A value to be used kama a modifier when triggering a particular event.',),
...
('ControlEvent','Event','N',Tupu, Tupu, Tupu, Tupu, 'Formatted',Tupu, 'An identifier that specifies the type of the event that should take place when the user interacts with control specified by the first two entries.',),
...
('Extension','Extension','N',Tupu, Tupu, Tupu, Tupu, 'Text',Tupu, 'The extension associated with the table row.',),
('Extension','MIME_','Y',Tupu, Tupu, 'MIME',1,'Text',Tupu, 'Optional Context identifier, typically "type/format" associated with the extension',),
('Extension','ProgId_','Y',Tupu, Tupu, 'ProgId',1,'Text',Tupu, 'Optional ProgId associated with this extension.',),
...
('FileSFPCatalog','File_','N',Tupu, Tupu, 'File',1,'Identifier',Tupu, 'File associated with the catalog',),
('FileSFPCatalog','SFPCatalog_','N',Tupu, Tupu, 'SFPCatalog',1,'Filename',Tupu, 'Catalog associated with the file',),
...
('IniLocator','Type','Y',0,2,Tupu, Tupu, Tupu, Tupu, 'An integer value that determines ikiwa the .INI value read ni a filename ama a directory location ama to be used kama ni w/o interpretation.',),
...
('InstallExecuteSequence','Condition','Y',Tupu, Tupu, Tupu, Tupu, 'Condition',Tupu, 'Optional expression which skips the action ikiwa evaluates to expUongo.If the expression syntax ni invalid, the engine will terminate, rudishaing iesBadActionData.',),
...
('InstallUISequence','Condition','Y',Tupu, Tupu, Tupu, Tupu, 'Condition',Tupu, 'Optional expression which skips the action ikiwa evaluates to expUongo.If the expression syntax ni invalid, the engine will terminate, rudishaing iesBadActionData.',),
...
('ListBox','Text','Y',Tupu, Tupu, Tupu, Tupu, 'Text',Tupu, 'The visible text to be assigned to the item. Optional. If this entry ama the entire column ni missing, the text ni the same kama the value.',),
...
('ListBox','Value','N',Tupu, Tupu, Tupu, Tupu, 'Formatted',Tupu, 'The value string associated with this item. Selecting the line will set the associated property to this value.',),
...
('ListView','Text','Y',Tupu, Tupu, Tupu, Tupu, 'Text',Tupu, 'The visible text to be assigned to the item. Optional. If this entry ama the entire column ni missing, the text ni the same kama the value.',),
...
('ListView','Value','N',Tupu, Tupu, Tupu, Tupu, 'Identifier',Tupu, 'The value string associated with this item. Selecting the line will set the associated property to this value.',),
...
('ListView','Binary_','Y',Tupu, Tupu, 'Binary',1,'Identifier',Tupu, 'The name of the icon to be displayed with the icon. The binary information ni looked up kutoka the Binary Table.',),
...
('ModuleExclusion','ModuleID','N',Tupu, Tupu, 'ModuleSignature',1,'Identifier',Tupu, 'String.GUID of module with exclusion requirement.',),
('ModuleExclusion','ModuleLanguage','N',Tupu, Tupu, 'ModuleSignature',2,Tupu, Tupu, 'LanguageID of module with exclusion requirement.',),
...
('MoveFile','DestName','Y',Tupu, Tupu, Tupu, Tupu, 'Filename',Tupu, 'Name to be given to the original file after it ni moved ama copied.  If blank, the destination file will be given the same name kama the source file',),
...
('MsiFileHash','File_','N',Tupu, Tupu, 'File',1,'Identifier',Tupu, 'Primary key, foreign key into File table referencing file with this hash',),
...
('ODBCDriver','Description','N',Tupu, Tupu, Tupu, Tupu, 'Text',Tupu, 'Text used kama registered name kila driver, non-localized',),
...
('ODBCDataSource','Description','N',Tupu, Tupu, Tupu, Tupu, 'Text',Tupu, 'Text used kama registered name kila data source',),
...
('ODBCTranslator','Description','N',Tupu, Tupu, Tupu, Tupu, 'Text',Tupu, 'Text used kama registered name kila translator',),
...
('Patch','Sequence','N',0,32767,Tupu, Tupu, Tupu, Tupu, 'Primary key, sequence with respect to the media images; order must track cabinet order.',),
...
('PublishComponent','AppData','Y',Tupu, Tupu, Tupu, Tupu, 'Text',Tupu, 'This ni localisable Application specific data that can be associated with a Qualified Component.',),
...
('RadioButton','Value','N',Tupu, Tupu, Tupu, Tupu, 'Formatted',Tupu, 'The value string associated with this button. Selecting the button will set the associated property to this value.',),
...
('RadioButton','Help','Y',Tupu, Tupu, Tupu, Tupu, 'Text',Tupu, 'The help strings used with the button. The text ni optional.',),
...
('RegLocator','Type','Y',0,18,Tupu, Tupu, Tupu, Tupu, 'An integer value that determines ikiwa the registry value ni a filename ama a directory location ama to be used kama ni w/o interpretation.',),
...
('ServiceInstall','Arguments','Y',Tupu, Tupu, Tupu, Tupu, 'Formatted',Tupu, 'Arguments to include kwenye every start of the service, pitaed to WinMain',),
('ServiceInstall','ServiceInstall','N',Tupu, Tupu, Tupu, Tupu, 'Identifier',Tupu, 'Primary key, non-localized token.',),
('ServiceInstall','Dependencies','Y',Tupu, Tupu, Tupu, Tupu, 'Formatted',Tupu, 'Other services this depends on to start.  Separate by [~], na end with [~][~]',),
...
('ServiceInstall','Password','Y',Tupu, Tupu, Tupu, Tupu, 'Formatted',Tupu, 'pitaword to run service with.  (with StartName)',),
...
('TypeLib','Cost','Y',0,2147483647,Tupu, Tupu, Tupu, Tupu, 'The cost associated with the registration of the typelib. This column ni currently optional.',),
...
('Upgrade','Language','Y',Tupu, Tupu, Tupu, Tupu, 'Language',Tupu, 'A comma-separated list of languages kila either products kwenye this set ama products haiko kwenye this set.',),
...
('Upgrade','VersionMax','Y',Tupu, Tupu, Tupu, Tupu, 'Text',Tupu, 'The maximum ProductVersion of the products kwenye this set.  The set may ama may sio include products with this particular version.',),
('Upgrade','VersionMin','Y',Tupu, Tupu, Tupu, Tupu, 'Text',Tupu, 'The minimum ProductVersion of the products kwenye this set.  The set may ama may sio include products with this particular version.',),
...
('Verb','Extension_','N',Tupu, Tupu, 'Extension',1,'Text',Tupu, 'The extension associated with the table row.',),
