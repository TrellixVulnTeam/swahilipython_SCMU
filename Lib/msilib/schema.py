...
('AdminExecuteSequence','Condition','Y',None, None, None, None, 'Condition',None, 'Optional expression which skips the action ikiwa evaluates to expFalse.If the expression syntax is invalid, the engine will terminate, returning iesBadActionData.',),
...
('Condition','Condition','Y',None, None, None, None, 'Condition',None, 'Expression evaluated to determine ikiwa Level in the Feature table is to change.',),
('Condition','Feature_','N',None, None, 'Feature',1,'Identifier',None, 'Reference to a Feature entry in Feature table.',),
('Condition','Level','N',0,32767,None, None, None, None, 'New selection Level to set in Feature table ikiwa Condition evaluates to TRUE.',),
...
('AdminUISequence','Condition','Y',None, None, None, None, 'Condition',None, 'Optional expression which skips the action ikiwa evaluates to expFalse.If the expression syntax is invalid, the engine will terminate, returning iesBadActionData.',),
...
('AdvtExecuteSequence','Condition','Y',None, None, None, None, 'Condition',None, 'Optional expression which skips the action ikiwa evaluates to expFalse.If the expression syntax is invalid, the engine will terminate, returning iesBadActionData.',),
...
('AdvtUISequence','Condition','Y',None, None, None, None, 'Condition',None, 'Optional expression which skips the action ikiwa evaluates to expFalse.If the expression syntax is invalid, the engine will terminate, returning iesBadActionData.',),
...
('Property','Property','N',None, None, None, None, 'Identifier',None, 'Name of property, uppercase ikiwa settable by launcher or loader.',),
...
('BBControl','Text','Y',None, None, None, None, 'Text',None, 'A string used to set the initial text contained within a control (ikiwa appropriate).',),
...
('Billboard','Action','Y',None, None, None, None, 'Identifier',None, 'The name of an action. The billboard is displayed during the progress messages received kutoka this action.',),
('Billboard','Billboard','N',None, None, None, None, 'Identifier',None, 'Name of the billboard.',),
('Billboard','Feature_','N',None, None, 'Feature',1,'Identifier',None, 'An external key to the Feature Table. The billboard is shown only ikiwa this feature is being installed.',),
...
('BindImage','Path','Y',None, None, None, None, 'Paths',None, 'A list of ;  delimited paths that represent the paths to be searched for the agiza DLLS. The list is usually a list of properties each enclosed within square brackets [] .',),
...
('File','Language','Y',None, None, None, None, 'Language',None, 'List of decimal language Ids, comma-separated ikiwa more than one.',),
...
('Class','Component_','N',None, None, 'Component',1,'Identifier',None, 'Required foreign key into the Component Table, specifying the component for which to rudisha a path when called through LocateComponent.',),
('Class','Context','N',None, None, None, None, 'Identifier',None, 'The numeric server context for this server. CLSCTX_xxxx',),
('Class','DefInprocHandler','Y',None, None, None, None, 'Filename','1;2;3','Optional default inproc handler.  Only optionally provided ikiwa Context=CLSCTX_LOCAL_SERVER.  Typically "ole32.dll" or "mapi32.dll"',),
...
('Component','Condition','Y',None, None, None, None, 'Condition',None, "A conditional statement that will disable this component ikiwa the specified condition evaluates to the 'True' state. If a component is disabled, it will not be installed, regardless of the 'Action' state associated with the component.",),
...
('Component','Directory_','N',None, None, 'Directory',1,'Identifier',None, 'Required key of a Directory table record. This is actually a property name whose value contains the actual path, set either by the AppSearch action or with the default setting obtained kutoka the Directory table.',),
('Component','KeyPath','Y',None, None, 'File;Registry;ODBCDataSource',1,'Identifier',None, 'Either the primary key into the File table, Registry table, or ODBCDataSource table. This extract path is stored when the component is installed, and is used to detect the presence of the component and to rudisha the path to it.',),
...
('CompLocator','Type','Y',0,1,None, None, None, None, 'A boolean value that determines ikiwa the registry value is a filename or a directory location.',),
...
('Control','Text','Y',None, None, None, None, 'Formatted',None, 'A string used to set the initial text contained within a control (ikiwa appropriate).',),
...
('Dialog','Control_Default','Y',None, None, 'Control',2,'Identifier',None, 'Defines the default control. Hitting rudisha is equivalent to pushing this button.',),
...
('Error','Error','N',0,32767,None, None, None, None, 'Integer error number, obtained kutoka header file IError(...) macros.',),
('Error','Message','Y',None, None, None, None, 'Template',None, 'Error formatting template, obtained kutoka user ed. or localizers.',),
...
('Extension','Component_','N',None, None, 'Component',1,'Identifier',None, 'Required foreign key into the Component Table, specifying the component for which to rudisha a path when called through LocateComponent.',),
...
('IniLocator','Type','Y',0,2,None, None, None, None, 'An integer value that determines ikiwa the .INI value read is a filename or a directory location or to be used as is w/o interpretation.',),
...
('InstallExecuteSequence','Condition','Y',None, None, None, None, 'Condition',None, 'Optional expression which skips the action ikiwa evaluates to expFalse.If the expression syntax is invalid, the engine will terminate, returning iesBadActionData.',),
...
('InstallUISequence','Condition','Y',None, None, None, None, 'Condition',None, 'Optional expression which skips the action ikiwa evaluates to expFalse.If the expression syntax is invalid, the engine will terminate, returning iesBadActionData.',),
...
('ListView','Binary_','Y',None, None, 'Binary',1,'Identifier',None, 'The name of the icon to be displayed with the icon. The binary information is looked up kutoka the Binary Table.',),
...
('MsiDigitalSignature','Hash','Y',None, None, None, None, 'Binary',None, 'The encoded hash blob kutoka the digital signature',),
...
('RegLocator','Type','Y',0,18,None, None, None, None, 'An integer value that determines ikiwa the registry value is a filename or a directory location or to be used as is w/o interpretation.',),
...
('ReserveCost','Component_','N',None, None, 'Component',1,'Identifier',None, 'Reserve a specified amount of space ikiwa this component is to be installed.',),
...
('ReserveCost','ReserveLocal','N',0,2147483647,None, None, None, None, 'Disk space to reserve ikiwa linked component is installed locally.',),
('ReserveCost','ReserveSource','N',0,2147483647,None, None, None, None, 'Disk space to reserve ikiwa linked component is installed to run kutoka the source location.',),
...
('ServiceInstall','ErrorControl','N',-2147483647,2147483647,None, None, None, None, 'Severity of error ikiwa service fails to start',),
...
('TypeLib','Component_','N',None, None, 'Component',1,'Identifier',None, 'Required foreign key into the Component Table, specifying the component for which to rudisha a path when called through LocateComponent.',),
...
('Upgrade','Remove','Y',None, None, None, None, 'Formatted',None, 'The list of features to remove when uninstalling a product kutoka this set.  The default is "ALL".',),
