...
('Upgrade','VersionMax','Y',Tupu, Tupu, Tupu, Tupu, 'Text',Tupu, 'The maximum ProductVersion of the products kwenye this set.  The set may ama may sio inlude products ukijumuisha this particular version.',),
('Upgrade','VersionMin','Y',Tupu, Tupu, Tupu, Tupu, 'Text',Tupu, 'The minimum ProductVersion of the products kwenye this set.  The set may ama may sio inlude products ukijumuisha this particular version.',),
