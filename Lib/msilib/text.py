agiza msilib,os;dirname=os.path.dirname(__file__)

ActionText = [
('InstallValidate', 'Validating install', Tupu),
...
('FileCost', 'Computing space requirements', Tupu),
('CostInitialize', 'Computing space requirements', Tupu),
('CostFinalize', 'Computing space requirements', Tupu),
...
('PublishProduct', 'Publishing product information', Tupu),
...
('AppSearch', 'Searching kila installed applications', 'Property: [1], Signature: [2]'),
('BindImage', 'Binding executables', 'File: [1]'),
('CCPSearch', 'Searching kila qualifying products', Tupu),
...
('FindRelatedProducts', 'Searching kila related applications', 'Found application: [1]'),
('InstallODBC', 'Installing ODBC components', Tupu),
('InstallServices', 'Installing new services', 'Service: [2]'),
('LaunchConditions', 'Evaluating launch conditions', Tupu),
('MigrateFeatureStates', 'Migrating feature states kutoka related applications', 'Application: [1]'),
('MoveFiles', 'Moving files', 'File: [1],  Directory: [9],  Size: [6]'),
('PatchFiles', 'Patching files', 'File: [1],  Directory: [2],  Size: [3]'),
('ProcessComponents', 'Updating component registration', Tupu),
('RegisterComPlus', 'Registering COM+ Applications na Components', 'AppId: [1]{{, AppType: [2], Users: [3], RSN: [4]}}'),
...
('UnregisterComPlus', 'Unregistering COM+ Applications na Components', 'AppId: [1]{{, AppType: [2]}}'),
...
('Advertise', 'Advertising application', Tupu),
('GenerateScript', 'Generating script operations kila action:', '[1]'),
...
('UnpublishProduct', 'Unpublishing product information', Tupu),
]
...
('MenuAllCD', 'Entire feature will be installed to run kutoka CD'),
('MenuAllLocal', 'Entire feature will be installed on local hard drive'),
('MenuAllNetwork', 'Entire feature will be installed to run kutoka network'),
('MenuCD', 'Will be installed to run kutoka CD'),
('MenuLocal', 'Will be installed on local hard drive'),
('MenuNetwork', 'Will be installed to run kutoka network'),
...
('SelAbsentCD', 'This feature will be installed to run kutoka CD'),
('SelAbsentLocal', 'This feature will be installed on the local hard drive'),
('SelAbsentNetwork', 'This feature will be installed to run kutoka the network'),
('SelAdvertiseAbsent', 'This feature will become unavailable'),
('SelAdvertiseAdvertise', 'Will be installed when required'),
('SelAdvertiseCD', 'This feature will be available to run kutoka CD'),
('SelAdvertiseLocal', 'This feature will be installed on your local hard drive'),
('SelAdvertiseNetwork', 'This feature will be available to run kutoka the network'),
('SelCDAbsent', "This feature will be uninstalled completely, you won't be able to run it kutoka CD"),
('SelCDAdvertise', 'This feature will change kutoka run kutoka CD state to set to be installed when required'),
('SelCDCD', 'This feature will remain to be run kutoka CD'),
('SelCDLocal', 'This feature will change kutoka run kutoka CD state to be installed on the local hard drive'),
('SelChildCostNeg', 'This feature frees up [1] on your hard drive.'),
('SelChildCostPos', 'This feature requires [1] on your hard drive.'),
('SelCostPending', 'Compiling cost kila this feature...'),
('SelLocalAbsent', 'This feature will be completely removed'),
('SelLocalAdvertise', 'This feature will be removed kutoka your local hard drive, but will be set to be installed when required'),
('SelLocalCD', 'This feature will be removed kutoka your local hard drive, but will be still available to run kutoka CD'),
('SelLocalLocal', 'This feature will remain on you local hard drive'),
('SelLocalNetwork', 'This feature will be removed kutoka your local hard drive, but will be still available to run kutoka the network'),
('SelNetworkAbsent', "This feature will be uninstalled completely, you won't be able to run it kutoka the network"),
('SelNetworkAdvertise', 'This feature will change kutoka run kutoka network state to set to be installed when required'),
('SelNetworkLocal', 'This feature will change kutoka run kutoka network state to be installed on the local hard drive'),
('SelNetworkNetwork', 'This feature will remain to be run kutoka the network'),
