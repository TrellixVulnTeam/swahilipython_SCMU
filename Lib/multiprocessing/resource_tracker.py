...
# resources. The server ignores SIGINT and SIGTERM and reads kutoka a
# pipe.  Every other process of the program has a copy of the writable
# end of the pipe, so we get EOF when all other processes have exited.
# Then the server process unlinks any remaining resource names.
#
# This is agizaant because there may be system limits for such resources: for
    ...
    def ensure_running(self):
        ...
        with self._lock:
            ...
            try:
                ...
                # to be spawned and will protect the child kutoka a race condition
