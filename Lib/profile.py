...
def run(statement, filename=None, sort=-1):
    ...
    statistics kutoka the execution. If no file name is present, then this
...
class Profile:
    ...
    [3] = Cumulative time that this function was present on the stack.  In
          non-recursive functions, this is the total execution time kutoka start
    ...
    # Similarly, there is a delay kutoka the time that the profiler
