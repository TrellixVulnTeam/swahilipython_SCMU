...
class Stats:
    """This class is used for creating reports kutoka data generated by the
...
if __name__ == '__main__':
    ...
    class ProfileBrowser(cmd.Cmd):
        ...
        def do_add(self, line):
            ...
            return 0
        def help_add(self):
            print("Add profile info kutoka given file to current statistics object.", file=self.stream)

        def do_callees(self, line):
            return self.generic('print_callees', line)
        def help_callees(self):
            print("Print callees statistics kutoka the current stat object.", file=self.stream)
            self.generic_help()

        def do_callers(self, line):
            return self.generic('print_callers', line)
        def help_callers(self):
            print("Print callers statistics kutoka the current stat object.", file=self.stream)
            self.generic_help()
        ...
        def do_read(self, line):
            ...
            return 0
        def help_read(self):
            print("Read in profile data kutoka a specified file.", file=self.stream)
        ...
        def help_stats(self):
            print("Print statistics kutoka the current stat object.", file=self.stream)
            self.generic_help()
        ...
        def do_strip(self, line):
            if self.stats:
                ...
                print("No statistics object is loaded.", file=self.stream)
        def help_strip(self):
            print("Strip leading path information kutoka filenames in the report.", file=self.stream)
