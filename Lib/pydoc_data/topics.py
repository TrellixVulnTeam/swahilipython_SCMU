...
topics = {'assert': 'The "assert" statement\n'
 ...
 'assignment': 'Assignment statements\n'
               ...
               'rules\n'
               'observed by various types na the exceptions ashiriad are given '
               'with the\n'
               ...
               'follows.\n'
               '\n'
               '* If the target list ni a single target with no trailing '
               'comma,\n'
               ...
               'an\n'
               '    iterable with at least kama many items kama there are targets '
               'in the\n'
               ...
               'is\n'
               '  ashiriad.  That object ni then asked to assign the assigned '
               'object to\n'
               ...
               '  attributes, such kama properties created with "property()".\n'
               '\n'
               ...
               'If the\n'
               '  index ni out of range, "IndexError" ni ashiriad (assignment to '
               'a\n'
               ...
               'replace an\n'
               '  existing key/value pair with the same key value, ama insert a '
               'new\n'
               ...
               'normal\n'
               'assignment statements, cannot be an unpacking) na the '
               'expression\n'
 ...
 'async': 'Coroutines\n'
          ...
          'keywords.\n'
          '\n'
          'It ni a "SyntaxError" to use a "tuma kutoka" expression inside the '
          'body\n'
          ...
          'See also:\n'
          '\n'
          '  **PEP 492** - Coroutines with async na await syntax\n'
 ...
 'atom-identifiers': 'Identifiers (Names)\n'
                     ...
                     'evaluate it\n'
                     'ashirias a "NameError" exception.\n'
                     '\n'
                     '**Private name mangling:** When an identifier that '
                     'textually occurs in\n'
                     'a kundi definition begins with two ama more underscore '
                     'characters and\n'
                     ...
                     'inserts the\n'
                     'kundi name, with leading underscores removed na a '
                     'single underscore\n'
 ...
 'attribute-access': 'Customizing attribute access\n'
                     ...
                     'an\n'
                     '   "AttributeError" (either "__getattribute__()" ashirias '
                     'an\n'
                     '   "AttributeError" because *name* ni sio an instance '
                     'attribute ama an\n'
                     '   attribute kwenye the kundi tree kila "self"; ama '
                     '"__get__()" of a *name*\n'
                     '   property ashirias "AttributeError").  This method '
                     'should either\n'
                     ...
                     '   calls it explicitly ama ashirias an "AttributeError". '
                     'This method\n'
                     ...
                     'sequence must be\n'
                     '   rudishaed. "dir()" converts the rudishaed sequence to a '
                     'list and\n'
                     '   sorts it.\n'
                     '\n'
                     '\n'
                     ...
                     '"AttributeError".\n'
                     'If found, it ni called with the attribute name na the '
                     'result is\n'
                     'rudishaed.\n'
                     '\n'
                     ...
                     '====================\n'
                     '\n'
                     'In general, a descriptor ni an object attribute with '
                     '“binding\n'
                     ...
                     'Attempts to\n'
                     '  assign to an unlisted variable name ashirias '
                     '"AttributeError". If\n'
 ...
 'attribute-references': 'Attribute references\n'
                         ...
                         '"AttributeError" is\n'
                         'ashiriad.  Otherwise, the type na value of the object '
                         'produced is\n'
 ...
 'binary': 'Binary arithmetic operations\n'
           ...
           'result.  Division by zero ashirias the "ZeroDivisionError" '
           'exception.\n'
           '\n'
           ...
           'first\n'
           'converted to a common type.  A zero right argument ashirias the\n'
           '"ZeroDivisionError" exception.  The arguments may be floating '
           'point\n'
           'numbers, e.g., "3.14%0.7" equals "0.34" (since "3.14" equals '
           '"4*0.7 +\n'
           '0.34".)  The modulo operator always tumas a result with the same '
           'sign\n'
 ...
 'bltin-null-object': 'The Null Object\n'
                      '***************\n'
                      '\n'
                      'This object ni rudishaed by functions that don’t '
 ...
 'booleans': 'Boolean operations\n'
             ...
             'its\n'
             'value ni rudishaed; otherwise, *y* ni evaluated na the resulting '
             'value\n'
             'is rudishaed.\n'
             '\n'
             'The expression "x ama y" first evaluates *x*; ikiwa *x* ni true, its '
             'value\n'
             'is rudishaed; otherwise, *y* ni evaluated na the resulting value '
             'is\n'
             'rudishaed.\n'
             '\n'
             ...
             'create a\n'
             'new value, it rudishas a boolean value regardless of the type of '
             'its\n'
             'argument (kila example, "not \'foo\'" produces "Uongo" rather '
             'than "\'\'".)\n',
 'koma': 'The "koma" statement\n'
          ...
          '\n'
          'When "koma" pitaes control out of a "try" statement with a '
          '"finally"\n'
 ...
 'calls': 'Calls\n'
          ...
          'is\n'
          'already filled, a "TypeError" exception ni ashiriad. Otherwise, the\n'
          ...
          '"TypeError"\n'
          'exception ni ashiriad.  Otherwise, the list of filled slots ni used '
          'as\n'
          ...
          'therefore cannot be supplied by keyword.  In CPython, this ni the '
          'case\n'
          ...
          'parameter\n'
          'slots, a "TypeError" exception ni ashiriad, unless a formal '
          'parameter\n'
          ...
          'name, a "TypeError" exception ni ashiriad, unless a formal parameter\n'
          'using the syntax "**identifier" ni present; kwenye this case, that '
          'formal\n'
          ...
          '*yM*,\n'
          'this ni equivalent to a call with M+4 positional arguments *x1*, '
          '*x2*,\n'
          '*y1*, …, *yM*, *x3*, *x4*.\n'
          '\n'
          ...
          'unpacking),\n'
          'a "TypeError" exception ni ashiriad.\n'
          '\n'
          'Formal parameters using the syntax "*identifier" ama "**identifier"\n'
          'cannot be used kama positional argument slots ama kama keyword argument\n'
          'names.\n'
          '\n'
          ...
          '\n'
          'A call always rudishas some value, possibly "Tupu", unless it ashirias '
          'an\n'
          ...
          'section\n'
          '   Function definitions.  When the code block executes a "rudisha"\n'
          ...
          '\n'
          'a kundi object:\n'
          '   A new instance of that kundi ni rudishaed.\n'
          '\n'
          'a kundi instance method:\n'
          '   The corresponding user-defined function ni called, with an '
          'argument\n'
 ...
 'class': 'Class definitions\n'
          ...
          'attributes\n'
          'can be set kwenye a method with "self.name = value".  Both kundi and\n'
 ...
 'comparisons': 'Comparisons\n'
                ...
                'of\n'
                'instances with the same identity results kwenye equality, na '
                'equality\n'
                ...
                'provided;\n'
                'an attempt ashirias "TypeError".  A motivation kila this default '
                'behavior\n'
                ...
                'types,\n'
                '  with the restriction that complex numbers do sio support '
                'order\n'
                ...
                'all false.\n'
                '  This behavior ni compliant with IEEE 754.\n'
                '\n'
                '* "Tupu" na "NotImplemented" are singletons.  **PEP 8** '
                'advises\n'
                '  that comparisons kila singletons should always be done with '
                '"is" or\n'
                ...
                '\n'
                '  Strings na binary sequences cannot be directly compared.\n'
                '\n'
                ...
                'across\n'
                '  these types ashirias "TypeError".\n'
                '\n'
                ...
                '     "x == y" na "not x != y"\n'
                '\n'
                '     "x < y" na "not x >= y" (kila total ordering)\n'
                '\n'
                '     "x > y" na "not x <= y" (kila total ordering)\n'
                '\n'
                ...
                '==========================\n'
                '\n'
                'The operators "in" na "not in" test kila membership.  "x kwenye '
                's"\n'
                'evaluates to "Kweli" ikiwa *x* ni a member of *s*, na "Uongo" '
                'otherwise.\n'
                '"x haiko kwenye s" rudishas the negation of "x kwenye s".  All built-in '
                'sequences\n'
                ...
                'method, "x\n'
                'in y" rudishas "Kweli" ikiwa "y.__contains__(x)" rudishas a true '
                'value, and\n'
                '"Uongo" otherwise.\n'
                '\n'
                ...
                'iterating\n'
                'over "y". If an exception ni ashiriad during the iteration, it '
                'is kama if\n'
                '"in" ashiriad that exception.\n'
                '\n'
                ...
                'y[i]", na no\n'
                'lower integer index ashirias the "IndexError" exception.  (If '
                'any other\n'
                'exception ni ashiriad, it ni kama ikiwa "in" ashiriad that '
                'exception).\n'
                '\n'
                'The operator "not in" ni defined to have the inverse truth '
                'value of\n'
                '"in".\n'
                '\n'
                '\n'
 ...
 'compound': 'Compound statements\n'
             ...
             'and ends\n'
             'with a colon.  A suite ni a group of statements controlled by a\n'
             ...
             'item\n'
             'provided by the iterator, kwenye the order rudishaed by the '
             'iterator.  Each\n'
             ...
             'when the\n'
             'sequence ni empty ama an iterator ashirias a "StopIteration" '
             'exception),\n'
             ...
             'endeleas\n'
             'with the next item, ama with the "else" clause ikiwa there ni no '
             'next\n'
             'item.\n'
             '\n'
             ...
             'to at\n'
             'all by the loop.  Hint: the built-in function "range()" rudishas '
             'an\n'
             'iterator of integers suitable to emulate the effect of Pascal’s '
             '"kila i\n'
             ':= a to b do"; e.g., "list(range(3))" rudishas the list "[0, 1, '
             '2]".\n'
             '\n'
             ...
             'exception.  For an tatizo clause with an expression, that '
             'expression\n'
             'is evaluated, na the clause matches the exception ikiwa the '
             'resulting\n'
             'object ni “compatible” with the exception.  An object ni '
             'compatible\n'
             'with an exception ikiwa it ni the kundi ama a base kundi of the '
             'exception\n'
             'object ama a tuple containing an item compatible with the '
             'exception.\n'
             '\n'
             ...
             'clause\n'
             'ashirias an exception, the original search kila a handler ni '
             'canceled and\n'
             ...
             'reference\n'
             'cycle with the stack frame, keeping all locals kwenye that frame '
             'alive\n'
             ...
             'via\n'
             '"sys.exc_info()". "sys.exc_info()" rudishas a 3-tuple consisting '
             'of the\n'
             ...
             'leaves the\n'
             '"try" suite, no exception was ashiriad, na no "rudisha", '
             '"endelea", or\n'
             ...
             'executed.  If\n'
             'there ni a saved exception it ni re-ashiriad at the end of the '
             '"finally"\n'
             'clause.  If the "finally" clause ashirias another exception, the '
             'saved\n'
             'exception ni set kama the context of the new exception. If the '
             '"finally"\n'
             'clause executes a "rudisha", "koma" ama "endelea" statement, the '
             'saved\n'
             ...
             '\n'
             'When a "rudisha", "koma" ama "endelea" statement ni executed kwenye '
             'the\n'
             ...
             'a\n'
             '"rudisha" statement executed kwenye the "finally" clause will always '
             'be the\n'
             'last one executed:\n'
             '\n'
             '   >>> eleza foo():\n'
             ...
             'Exceptions, na information on using the "ashiria" statement to '
             'generate\n'
             'exceptions may be found kwenye section The ashiria statement.\n'
             '\n'
             'Changed kwenye version 3.8: Prior to Python 3.8, a "endelea" '
             'statement\n'
             'was illegal kwenye the "finally" clause due to a problem with the\n'
             'implementation.\n'
             '\n'
             '\n'
             'The "with" statement\n'
             ...
             '\n'
             '4. If a target was included kwenye the "with" statement, the rudisha\n'
             '   value kutoka "__enter__()" ni assigned to it.\n'
             '\n'
             '   Note: The "with" statement guarantees that ikiwa the '
             '"__enter__()"\n'
             '     method rudishas without an error, then "__exit__()" will '
             'always be\n'
             ...
             'and\n'
             '   execution endeleas with the statement following the "with"\n'
             '   statement.\n'
             '\n'
             ...
             'The\n'
             'result must be a callable, which ni invoked with the function '
             'object\n'
             'as the only argument. The rudishaed value ni bound to the '
             'function name\n'
             ...
             'Functions may\n'
             'have “rudisha” annotation of the form “"-> expression"” after '
             'the\n'
             ...
             'function that can be rudishaed ama pitaed around.  Free variables '
             'used\n'
             ...
             'kundi attributes; they are shared by instances.  Instance '
             'attributes\n'
             'can be set kwenye a method with "self.name = value".  Both kundi '
             'and\n'
             'instance attributes are accessible through the notation '
             '“"self.name"”,\n'
             'and an instance attribute hides a kundi attribute with the same '
             ...
             'keywords.\n'
             '\n'
             'It ni a "SyntaxError" to use a "tuma kutoka" expression inside '
             'the body\n'
             'of a coroutine function.\n'
             '\n'
             'An example of a coroutine function:\n'
 ...
 'context-managers': 'With Statement Context Managers\n'
                     ...
                     'context manager\n'
                     'handles the entry into, na the exit kutoka, the desired '
                     'runtime context\n'
 ...
 'endelea': 'The "endelea" statement\n'
             ...
             'that\n'
             'loop.  It endeleas with the next cycle of the nearest enclosing '
             'loop.\n'
             '\n'
             'When "endelea" pitaes control out of a "try" statement with a\n'
 ...
 'customization': 'Basic customization\n'
                  ...
                  '"__new__()"), but\n'
                  '   before it ni rudishaed to the caller.  The arguments are '
                  'those\n'
                  ...
                  'customize\n'
                  '   it), no non-"Tupu" value may be rudishaed by '
                  '"__init__()"; doing so\n'
                  '   will cause a "TypeError" to be ashiriad at runtime.\n'
                  '\n'
                  'object.__del__(self)\n'
                  '\n'
                  ...
                  'form\n'
                  '   "<...some useful description...>" should be rudishaed. '
                  'The rudisha\n'
                  ...
                  'required.\n'
                  '\n'
                  '   This ni typically used kila debugging, so it ni agizaant '
                  'that the\n'
                  ...
                  '"object" itself\n'
                  '   ashirias a "TypeError" ikiwa pitaed any non-empty string.\n'
                  '\n'
                  ...
                  '\n'
                  '   See the paragraph on "__hash__()" kila some agizaant '
                  'notes on\n'
                  ...
                  '\n'
                  '   Note: "hash()" truncates the value rudishaed kutoka an '
                  'object’s\n'
                  ...
                  'all\n'
                  '     supported builds.  An easy way to do this ni with '
                  '"python -c\n'
                  ...
                  'methods by\n'
                  '   default; with them, all objects compare unequal (tatizo '
                  'with\n'
                  '   themselves) na "x.__hash__()" rudishas an appropriate '
                  'value such\n'
                  ...
                  'that\n'
                  '   explicitly ashirias a "TypeError" would be incorrectly '
                  'identified as\n'
 ...
 'debugger': '"pdb" — The Python Debugger\n'
             ...
             'object)\n'
             '   under debugger control.  When "runeval()" rudishas, it rudishas '
             'the\n'
             ...
             'string)\n'
             '   with the given arguments.  When "runcall()" rudishas, it '
             'rudishas\n'
             '   whatever the function call rudishaed.  The debugger prompt '
             'appears\n'
             ...
             'a\n'
             '   *command* kama argument, print help about that command.  "help '
             'pdb"\n'
             ...
             'prefixed\n'
             '   with a filename na a colon, to specify a komapoint kwenye '
             'another\n'
             ...
             'may be\n'
             '   desirable kila komapoints that are to print a specific '
             'message and\n'
             '   then endelea.  If none of the other commands print anything, '
             'you\n'
             ...
             'function is\n'
             '   reached ama it rudishas.  (The difference between "next" na '
             '"step"\n'
             ...
             '\n'
             '   With a line number, endelea execution until a line with a '
             'number\n'
             ...
             'was\n'
             '   originally ashiriad ama propagated ni indicated by ">>", ikiwa it '
             'differs\n'
             ...
             'p expression\n'
             '\n'
             '   Evaluate the *expression* kwenye the current context na print '
             'its\n'
             '   value.\n'
             '\n'
 ...
 'del': 'The "del" statement\n'
        ...
        '"NameError" exception will be ashiriad.\n'
        '\n'
 ...
 'exceptions': 'Exceptions\n'
               ...
               'exceptional\n'
               'conditions.  An exception ni *ashiriad* at the point where the '
               'error is\n'
               ...
               'the error occurred.\n'
               '\n'
               'The Python interpreter ashirias an exception when it detects a '
               'run-time\n'
               'error (such kama division by zero).  A Python program can also\n'
               'explicitly ashiria an exception with the "ashiria" statement. '
               'Exception\n'
               ...
               'an outer\n'
               'level, but it cannot repair the cause of the error na retry '
               'the\n'
               ...
               'terminates\n'
               'execution of the program, ama rudishas to its interactive main '
               'loop.  In\n'
               ...
               'try\n'
               'statement na "ashiria" statement kwenye section The ashiria '
               'statement.\n'
               '\n'
               '-[ Footnotes ]-\n'
               '\n'
 ...
 'execmodel': 'Execution model\n'
              ...
              'functions,\n'
              '"agiza" statements, kundi na function definitions (these bind '
              'the\n'
              ...
              'or after\n'
              '"as" kwenye a "with" statement ama "except" clause. The "agiza" '
              'statement\n'
              'of the form "kutoka ... agiza *" binds all names defined kwenye the\n'
              'imported module, tatizo those beginning with an underscore.  '
              'This form\n'
              ...
              'where the\n'
              'name ni used, an "UnboundLocalError" exception ni ashiriad.\n'
              ...
              'scope.\n'
              '"SyntaxError" ni ashiriad at compile time ikiwa the given name does '
              'not\n'
              ...
              'references\n'
              'follow the normal rules kila name resolution with an exception '
              'that\n'
 ...
 'for': 'The "for" statement\n'
        ...
        'provided by the iterator, kwenye the order rudishaed by the iterator.  '
        'Each\n'
        ...
        'executed kwenye the first suite skips the rest of the suite na '
        'endeleas\n'
        'with the next item, ama with the "else" clause ikiwa there ni no next\n'
        'item.\n'
        '\n'
        ...
        'all by the loop.  Hint: the built-in function "range()" rudishas an\n'
        'iterator of integers suitable to emulate the effect of Pascal’s "kila '
        'i\n'
        ':= a to b do"; e.g., "list(range(3))" rudishas the list "[0, 1, 2]".\n'
        '\n'
 ...
 'formatstrings': 'Format String Syntax\n'
                  ...
                  '\n'
                  'The *field_name* itself begins with an *arg_name* that ni '
                  'either a\n'
                  ...
                  'are 0, 1, 2,\n'
                  '… kwenye sequence, they can all be omitted (not just some) na '
                  'the numbers\n'
                  ...
                  'value\n'
                  'formatted with "\'f\'" na "\'F\'", ama before na after the '
                  'decimal point\n'
                  'kila a floating point value formatted with "\'g\'" ama '
                  '"\'G\'".  For non-\n'
                  ...
                  '"%"-formatting,\n'
                  'with the addition of the "{}" na with ":" used instead of '
                  '"%". For\n'
 ...
 'global': 'The "global" statement\n'
           ...
           'function definition, "agiza" statement, ama variable annotation.\n'
           '\n'
 ...
 'identifiers': 'Identifiers na keywords\n'
                ...
                'standard\n'
                'annex UAX-31, with elaboration na changes kama defined below; '
                'see also\n'
                ...
                'Ll, Lt, Lm, Lo, Nl, the underscore, na characters with the '
                'Other_ID_Start property>\n'
                '   id_endelea  ::= <all characters kwenye id_start, plus '
                'characters kwenye the categories Mn, Mc, Nd, Pc na others with '
                ...
                '*keywords* of\n'
                'the language, na cannot be used kama ordinary identifiers.  '
                'They must\n'
                'be spelled exactly kama written here:\n'
                '\n'
                '   Uongo      await      else       agiza     pita\n'
                '   Tupu       koma      tatizo     kwenye         ashiria\n'
                '   Kweli       kundi      finally    ni         rudisha\n'
                '   na        endelea   kila        lambda     try\n'
                '   kama         eleza        kutoka       nonlocal   while\n'
                '   assert     toa        global     sio        with\n'
                '   async      elikiwa       ikiwa         ama         tuma\n'
                '\n'
                '\n'
 ...
 'imaginary': 'Imaginary literals\n'
              ...
              '\n'
              'An imaginary literal tumas a complex number with a real part '
              'of 0.0.\n'
 ...
 'agiza': 'The "agiza" statement\n'
           ...
           '\n'
           'The basic agiza statement (no "kutoka" clause) ni executed kwenye two\n'
           'steps:\n'
           '\n'
           ...
           '\n'
           '1. find the module specified kwenye the "kutoka" clause, loading and\n'
           '   initializing it ikiwa necessary;\n'
           '\n'
           '2. kila each of the identifiers specified kwenye the "agiza" clauses:\n'
           '\n'
           '   1. check ikiwa the imported module has an attribute by that name\n'
           '\n'
           '   2. ikiwa not, attempt to agiza a submodule with that name na '
           'then\n'
           '      check the imported module again kila that attribute\n'
           '\n'
           '   3. ikiwa the attribute ni sio found, "ImportError" ni ashiriad.\n'
           '\n'
           ...
           'By\n'
           'using leading dots kwenye the specified module ama package after "kutoka" '
           'you\n'
           ...
           'specification kila relative agizas ni contained kwenye the Package\n'
           ...
           'have\n'
           'been defined, na ashirias a compile-time error ikiwa a future '
           'statement\n'
           ...
           'statement\n'
           'will, by default, use the new syntax ama semantics associated with '
           'the\n'
           ...
           'interpreter ni started with the "-i" option, ni pitaed a script '
           'name\n'
 ...
 'in': 'Membership test operations\n'
       '**************************\n'
       '\n'
       'The operators "in" na "not in" test kila membership.  "x kwenye s"\n'
       ...
       'in y" rudishas "Kweli" ikiwa "y.__contains__(x)" rudishas a true value, and\n'
       '"Uongo" otherwise.\n'
       '\n'
       ...
       'the expression "x ni z ama x == z" ni true, ni produced wakati '
       'iterating\n'
       'over "y". If an exception ni ashiriad during the iteration, it ni kama if\n'
       '"in" ashiriad that exception.\n'
       '\n'
       ...
       'lower integer index ashirias the "IndexError" exception.  (If any other\n'
       'exception ni ashiriad, it ni kama ikiwa "in" ashiriad that exception).\n'
       '\n'
       'The operator "not in" ni defined to have the inverse truth value of\n'
       '"in".\n',
 'integers': 'Integer literals\n'
             ...
             'allowed.\n'
             'This ni kila disambiguation with C-style octal literals, which '
             'Python\n'
 ...
 'naming': 'Naming na binding\n'
           ...
           'statement\n'
           'of the form "kutoka ... agiza *" binds all names defined kwenye the\n'
           'imported module, tatizo those beginning with an underscore.  This '
           'form\n'
           'may only be used at the module level.\n'
           '\n'
 ...
 'nonlocal': 'The "nonlocal" statement\n'
             ...
             'excluding\n'
             'globals. This ni agizaant because the default behavior kila '
             'binding is\n'
             ...
             '\n'
             'Names listed kwenye a "nonlocal" statement must sio collide with '
             'pre-\n'
 ...
 'numbers': 'Numeric literals\n'
            ...
            'imaginary number).\n'
            '\n'
            'Note that numeric literals do sio include a sign; a phrase like '
            '"-1"\n'
 ...
 'numeric-types': 'Emulating numeric types\n'
                  ...
                  'a class\n'
                  '   with an "__iadd__()" method, "x += y" ni equivalent to '
                  '"x =\n'
                  '   x.__iadd__(y)" . Otherwise, "x.__add__(y)" na '
                  '"y.__radd__(x)" are\n'
                  '   considered, kama with the evaluation of "x + y". In '
                  'certain\n'
 ...
 'objects': 'Objects, values na types\n'
            ...
            'the\n'
            'identity of two objects; the "id()" function rudishas an integer\n'
            ...
            'values\n'
            'kila objects of that type.  The "type()" function rudishas an '
            'object’s\n'
            ...
            'of\n'
            'objects it contains cannot be changed.  So, immutability ni not\n'
            ...
            'agizaance of object identity ni affected kwenye some sense: kila '
            'immutable\n'
            'types, operations that compute new values may actually rudisha a\n'
            'reference to any existing object with the same type na value, '
            'while\n'
            'kila mutable objects this ni sio allowed.  E.g., after "a = 1; b = '
            '1",\n'
            '"a" na "b" may ama may sio refer to the same object with the '
            'value\n'
 ...
 'operator-summary': 'Operator precedence\n'
                     ...
                     'function\n'
                     '    "math.fmod()" rudishas a result whose sign matches '
                     'the sign of the\n'
                     '    first argument instead, na so rudishas "-1e-100" kwenye '
                     'this case.\n'
                     ...
                     '"(x-x%y)//y" due to\n'
                     '    rounding.  In such cases, Python rudishas the latter '
                     'result, in\n'
 ...
 'pita': 'The "pita" statement\n'
         ...
         '\n'
         '   kundi C: pita       # a kundi with no methods (yet)\n',
 'power': 'The power operator\n'
          ...
          'function, when called with two arguments: it tumas its left '
          'argument\n'
          'ashiriad to the power of its right argument.  The numeric arguments '
          'are\n'
          ...
          '"10**2" rudishas "100", but "10**-2" rudishas "0.01".\n'
          '\n'
          'Raising "0.0" to a negative power results kwenye a '
          '"ZeroDivisionError".\n'
          'Raising a negative number to a fractional power results kwenye a '
          '"complex"\n'
          'number. (In earlier versions it ashiriad a "ValueError".)\n',
 'ashiria': 'The "ashiria" statement\n'
          '*********************\n'
          '\n'
          '   ashiria_stmt ::= "ashiria" [expression ["kutoka" expression]]\n'
          '\n'
          'If no expressions are present, "ashiria" re-ashirias the last '
          'exception\n'
          'that was active kwenye the current scope.  If no exception ni active '
          'in\n'
          'the current scope, a "RuntimeError" exception ni ashiriad indicating\n'
          'that this ni an error.\n'
          '\n'
          'Otherwise, "ashiria" evaluates the first expression kama the exception\n'
          ...
          'exception\n'
          'is ashiriad na attached to it kama the "__traceback__" attribute, '
          'which\n'
          ...
          '\n'
          'The "kutoka" clause ni used kila exception chaining: ikiwa given, the '
          'second\n'
          '*expression* must be another exception kundi ama instance, which '
          'will\n'
          'then be attached to the ashiriad exception kama the "__cause__" '
          'attribute\n'
          '(which ni writable).  If the ashiriad exception ni sio handled, both\n'
          ...
          '\n'
          'A similar mechanism works implicitly ikiwa an exception ni ashiriad '
          'inside\n'
 ...
 'rudisha': 'The "rudisha" statement\n'
           '**********************\n'
           '\n'
           '   rudisha_stmt ::= "rudisha" [expression_list]\n'
           '\n'
           '"rudisha" may only occur syntactically nested kwenye a function '
           'definition,\n'
           'not within a nested kundi definition.\n'
           '\n'
           'If an expression list ni present, it ni evaluated, else "Tupu" is\n'
           'substituted.\n'
           '\n'
           '"rudisha" leaves the current function call with the expression list '
           '(or\n'
           '"Tupu") kama rudisha value.\n'
           '\n'
           'When "rudisha" pitaes control out of a "try" statement with a '
           '"finally"\n'
           'clause, that "finally" clause ni executed before really leaving '
           'the\n'
           'function.\n'
           '\n'
           'In a generator function, the "rudisha" statement indicates that '
           'the\n'
           'generator ni done na will cause "StopIteration" to be ashiriad. '
           'The\n'
           'rudishaed value (ikiwa any) ni used kama an argument to construct\n'
           '"StopIteration" na becomes the "StopIteration.value" attribute.\n'
           '\n'
           'In an asynchronous generator function, an empty "rudisha" '
           'statement\n'
           'indicates that the asynchronous generator ni done na will cause\n'
           '"StopAsyncIteration" to be ashiriad.  A non-empty "rudisha" statement '
           'is\n'
 ...
 'sequence-types': 'Emulating container types\n'
                   ...
                   '"__len__()" method\n'
                   '   rudishas zero ni considered to be false kwenye a Boolean '
                   'context.\n'
                   '\n'
                   ...
                   '\n'
                   'Note: Slicing ni done exclusively with the following three '
                   'methods.\n'
                   '  A call like\n'
                   '\n'
                   '     a[1:2] = b\n'
                   ...
                   '   ashiriad. For mapping types, ikiwa *key* ni missing (not kwenye '
                   'the\n'
                   '   container), "KeyError" should be ashiriad.\n'
                   '\n'
                   ...
                   'replaced.  The\n'
                   '   same exceptions should be ashiriad kila improper *key* '
                   'values kama for\n'
                   ...
                   'should be\n'
                   '   ashiriad kila improper *key* values kama kila the '
                   '"__getitem__()" method.\n'
                   '\n'
                   ...
                   '   "reversed()".\n'
                   '\n'
                   'The membership test operators ("in" na "not in") are '
                   'normally\n'
 ...
 'shifting': 'Shifting operations\n'
             ...
             '"pow(2,n)".\n'
             'A left shift by *n* bits ni defined kama multiplication with '
             '"pow(2,n)".\n',
 'slicings': 'Slicings\n'
             '********\n'
             '\n'
 ...
 'specialattrs': 'Special Attributes\n'
                 ...
                 'immediate\n'
                 '   subclasses.  This method rudishas a list of all those '
                 'references\n'
                 '   still alive. Example:\n'
                 '\n'
                 '      >>> int.__subclasses__()\n'
 ...
 'specialnames': 'Special method names\n'
                 ...
                 'slicing) by\n'
                 'defining methods with special names. This ni Python’s '
                 'approach to\n'
                 ...
                 '   objects ("__new__()" to create it, na "__init__()" to '
                 'customize\n'
                 '   it), no non-"Tupu" value may be rudishaed by "__init__()"; '
                 'doing so\n'
                 '   will cause a "TypeError" to be ashiriad at runtime.\n'
                 '\n'
                 'object.__del__(self)\n'
                 ...
                 '   environment).  If this ni sio possible, a string of the '
                 'form\n'
                 '   "<...some useful description...>" should be rudishaed. The '
                 'rudisha\n'
                 '   value must be a string object. If a kundi defines '
                 '"__repr__()" but\n'
                 '   sio "__str__()", then "__repr__()" ni also used when an '
                 ...
                 '   ikiwa it does sio implement the operation kila a given pair '
                 'of\n'
                 '   arguments. By convention, "Uongo" na "Kweli" are rudishaed '
                 'kila a\n'
                 '   successful comparison. However, these methods can rudisha '
                 'any value,\n'
                 '   so ikiwa the comparison operator ni used kwenye a Boolean '
                 ...
                 '   "AttributeError" (either "__getattribute__()" ashirias an\n'
                 '   "AttributeError" because *name* ni sio an instance '
                 'attribute ama an\n'
                 '   attribute kwenye the kundi tree kila "self"; ama "__get__()" of '
                 'a *name*\n'
                 '   property ashirias "AttributeError").  This method should '
                 'either\n'
                 '   rudisha the (computed) attribute value ama ashiria an '
                 '"AttributeError"\n'
                 '   exception.\n'
                 ...
                 'either\n'
                 '   calls it explicitly ama ashirias an "AttributeError". This '
                 'method\n'
                 ...
                 '   If "__setattr__()" wants to assign to an instance '
                 'attribute, it\n'
                 '   should call the base kundi method with the same name, kila '
                 'example,\n'
                 '   "object.__setattr__(self, name, value)".\n'
                 '\n'
                 'object.__delattr__(self, name)\n'
                 ...
                 '   "AttributeError" exception.\n'
                 '\n'
                 '   **PEP 252** specifies that "__get__()" ni callable with '
                 'one ama two\n'
                 '   arguments.  Python’s own built-in descriptors support '
                 'this\n'
                 '   specification; however, it ni likely that some '
                 ...
                 'just the\n'
                 '"__get__()" method.  Data descriptors with "__set__()" na '
                 '"__get__()"\n'
                 'defined always override a redefinition kwenye an instance '
                 'dictionary.  In\n'
                 'contrast, non-data descriptors can be overridden by '
                 ...
                 'does nothing,\n'
                 '   but ashirias an error ikiwa it ni called with any arguments.\n'
                 '\n'
                 ...
                 'If found,\n'
                 'it ni called with the original bases tuple. This method must '
                 'rudisha a\n'
                 ...
                 '(metaclass) of a\n'
                 'class.  They cannot be defined kama kundi methods kwenye the '
                 'actual class.\n'
                 'This ni consistent with the lookup of special methods that '
                 'are called\n'
                 ...
                 'and\n'
                 '     "__subclasscheck__()", with motivation kila this '
                 'functionality in\n'
                 ...
                 'method.  Note,\n'
                 'this mechanism ni primarily reserved kila use with static '
                 'type hints,\n'
                 ...
                 '   required to be at most "sys.maxsize". If the length ni '
                 'larger than\n'
                 '   "sys.maxsize" some features (such kama "len()") may ashiria\n'
                 '   "OverflowError".  To prevent raising "OverflowError" by '
                 'truth value\n'
                 '   testing, an object must define a "__bool__()" method.\n'
                 '\n'
                 ...
                 'class\n'
                 '   with an "__iadd__()" method, "x += y" ni equivalent to "x '
                 '=\n'
                 '   x.__iadd__(y)" . Otherwise, "x.__add__(y)" na '
                 '"y.__radd__(x)" are\n'
                 '   considered, kama with the evaluation of "x + y". In '
                 ...
                 'reason why\n'
                 'the following code ashirias an exception:\n'
                 '\n'
                 '   >>> kundi C:\n'
                 '   ...     pita\n'
                 '   ...\n'
 ...
 'string-methods': 'String Methods\n'
                   ...
                   'space). The\n'
                   '   original string ni rudishaed ikiwa *width* ni less than ama '
                   'equal to\n'
                   '   "len(s)".\n'
                   '\n'
                   ...
                   '\n'
                   '   Return "Kweli" ikiwa the string ends with the specified '
                   '*suffix*,\n'
                   ...
                   'each\n'
                   '   replacement field ni replaced with the string value of '
                   'the\n'
                   ...
                   '"complex",\n'
                   '     "decimal.Decimal" na subclasses) with the "n" type '
                   '(ex:\n'
                   ...
                   '\n'
                   '   Changed kwenye version 3.7: When formatting a number with '
                   'the "n" type,\n'
                   ...
                   'character "c"\n'
                   '   ni alphanumeric ikiwa one of the following rudishas '
                   '"Kweli":\n'
                   ...
                   'character\n'
                   '   database kama “Letter”, i.e., those with general category '
                   'property\n'
                   ...
                   'strings in\n'
                   '   *iterable*. A "TypeError" will be ashiriad ikiwa there are '
                   'any non-\n'
                   ...
                   'is an ASCII\n'
                   '   space). The original string ni rudishaed ikiwa *width* ni '
                   'less than or\n'
                   '   equal to "len(s)".\n'
                   '\n'
                   'str.lower()\n'
                   ...
                   '\n'
                   '   This static method rudishas a translation table usable '
                   'for\n'
                   '   "str.translate()".\n'
                   '\n'
                   ...
                   '\n'
                   '   Like "rfind()" but ashirias "ValueError" when the '
                   'substring *sub* is\n'
                   '   sio found.\n'
                   '\n'
                   ...
                   '   "\'1,,2\'.split(\',\')" rudishas "[\'1\', \'\', '
                   '\'2\']").  The *sep* argument\n'
                   '   may consist of multiple characters (kila example,\n'
                   '   "\'1<>2<>3\'.split(\'<>\')" rudishas "[\'1\', \'2\', '
                   '\'3\']"). Splitting an\n'
                   '   empty string with a specified separator rudishas '
                   '"[\'\']".\n'
                   '\n'
                   '   For example:\n'
                   '\n'
                   ...
                   'a string\n'
                   '   consisting of just whitespace with a "Tupu" separator '
                   'rudishas "[]".\n'
                   '\n'
                   '   For example:\n'
                   '\n'
                   ...
                   'line\n'
                   '   boundaries.  Line komas are sio included kwenye the '
                   'resulting list\n'
                   ...
                   'given, this\n'
                   '   method rudishas an empty list kila the empty string, na '
                   'a terminal\n'
                   ...
                   '\n'
                   '   Return "Kweli" ikiwa string starts with the *prefix*, '
                   'otherwise rudisha\n'
                   ...
                   'str.strip([chars])\n'
                   '\n'
                   '   Return a copy of the string with the leading na '
                   'trailing\n'
 ...
 'strings': 'String na Bytes literals\n'
            ...
            '\n'
            'One syntactic restriction sio indicated by these productions ni '
            'that\n'
            ...
            'character.\n'
            '\n'
            'Bytes literals are always prefixed with "\'b\'" ama "\'B\'"; they '
            'produce\n'
            ...
            '\n'
            'Both string na bytes literals may optionally be prefixed with a\n'
            ...
            'information.\n'
            '\n'
            'A string literal with "\'f\'" ama "\'F\'" kwenye its prefix ni a '
            '*formatted\n'
            'string literal*; see Formatted string literals.  The "\'f\'" may '
            'be\n'
            'combined with "\'r\'", but sio with "\'b\'" ama "\'u\'", therefore '
            'raw\n'
            ...
            'also\n'
            'agizaant to note that the escape sequences only recognized kwenye '
            'string\n'
            ...
            '\n'
            'Even kwenye a raw literal, quotes can be escaped with a backslash, '
            'but the\n'
            ...
            'literal\n'
            'cannot end kwenye a single backslash* (since the backslash would '
            'escape\n'
 ...
 'truth': 'Truth Value Testing\n'
          ...
          'either a "__bool__()" method that rudishas "Uongo" ama a "__len__()"\n'
          'method that rudishas zero, when called with the object. [1]  Here '
          'are\n'
 ...
 'try': 'The "try" statement\n'
        ...
        'expression-\n'
        'less tatizo clause, ikiwa present, must be last; it matches any\n'
        'exception.  For an tatizo clause with an expression, that expression\n'
        'is evaluated, na the clause matches the exception ikiwa the resulting\n'
        'object ni “compatible” with the exception.  An object ni compatible\n'
        'with an exception ikiwa it ni the kundi ama a base kundi of the '
        'exception\n'
        'object ama a tuple containing an item compatible with the exception.\n'
        '\n'
        'If no tatizo clause matches the exception, the search kila an '
        'exception\n'
        'handler endeleas kwenye the surrounding code na on the invocation '
        ...
        'ashirias an exception, the original search kila a handler ni canceled '
        'and\n'
        ...
        'cycle with the stack frame, keeping all locals kwenye that frame alive\n'
        'until the next garbage collection occurs.\n'
        '\n'
        'Before an tatizo clause’s suite ni executed, details about the\n'
        'exception are stored kwenye the "sys" module na can be accessed via\n'
        '"sys.exc_info()". "sys.exc_info()" rudishas a 3-tuple consisting of '
        'the\n'
        ...
        'restored to their previous values (before the call) when rudishaing\n'
        'kutoka a function that handled an exception.\n'
        '\n'
        'The optional "else" clause ni executed ikiwa the control flow leaves '
        'the\n'
        '"try" suite, no exception was ashiriad, na no "rudisha", "endelea", '
        'or\n'
        ...
        'there ni a saved exception it ni re-ashiriad at the end of the '
        '"finally"\n'
        'clause.  If the "finally" clause ashirias another exception, the saved\n'
        'exception ni set kama the context of the new exception. If the '
        '"finally"\n'
        'clause executes a "rudisha", "koma" ama "endelea" statement, the '
        'saved\n'
        ...
        'execution of the "finally" clause.\n'
        '\n'
        'When a "rudisha", "koma" ama "endelea" statement ni executed kwenye the\n'
        '"try" suite of a "try"…"finally" statement, the "finally" clause is\n'
        'also executed ‘on the way out.’\n'
        '\n'
        'The rudisha value of a function ni determined by the last "rudisha"\n'
        'statement executed.  Since the "finally" clause always executes, a\n'
        '"rudisha" statement executed kwenye the "finally" clause will always be '
        'the\n'
        'last one executed:\n'
        '\n'
        '   >>> eleza foo():\n'
 ...
 'types': 'The standard type hierarchy\n'
          ...
          'the\n'
          'implementation na are sio intended kila general use.  Their '
          'definition\n'
          'may change kwenye the future.\n'
          '\n'
          'Tupu\n'
          '   This type has a single value.  There ni a single object with '
          'this\n'
          ...
          'e.g.,\n'
          '   it ni rudishaed kutoka functions that don’t explicitly rudisha\n'
          ...
          '\n'
          '"numbers.Number"\n'
          '   These are created by numeric literals na rudishaed kama results '
          'by\n'
          ...
          '         ""Kweli"" are rudishaed, respectively.\n'
          '\n'
          ...
          '   numbers. The built-in function "len()" rudishas the number of '
          'items\n'
          ...
          'represented\n'
          '         kama a string object with length "1".  The built-in '
          'function\n'
          ...
          '   rudishas the number of items kwenye a set. Common uses kila sets are '
          'fast\n'
          ...
          'function\n'
          '   "len()" rudishas the number of items kwenye a mapping.\n'
          '\n'
          ...
          'function*.\n'
          '      Such a function, when called, always rudishas an iterator '
          'object\n'
          ...
          '"tuma"\n'
          '      statement.  When the function executes a "rudisha" statement '
          'or\n'
          '      falls off the end, a "StopIteration" exception ni ashiriad na '
          'the\n'
          ...
          'called,\n'
          '      rudishas a *coroutine* object.  It may contain "await"\n'
          ...
          '      generator function*.  Such a function, when called, rudishas '
          'an\n'
          ...
          'expression.\n'
          '      When the function executes an empty "rudisha" statement ama '
          'falls\n'
          '      off the end, a "StopAsyncIteration" exception ni ashiriad na '
          'the\n'
          ...
          '   created by the agiza system kama invoked either by the "agiza"\n'
          ...
          'has\n'
          '   an attribute by that name, the search endeleas with the class\n'
          ...
          '      (including positional-only arguments na arguments with '
          'default\n'
          ...
          '      (including arguments with default values); "co_nlocals" ni '
          'the\n'
          ...
          '      function; "co_lnotab" ni a string encoding the mapping kutoka\n'
          ...
          'to\n'
          '      undefined interpreter behaviour ikiwa exceptions ashiriad by the\n'
          ...
          '\n'
          '         "RuntimeError" ni ashiriad ikiwa the frame ni currently '
          'executing.\n'
          '\n'
          '         New kwenye version 3.4.\n'
          '\n'
          ...
          '      rudishaed by "sys.exc_info()", na kama the "__traceback__"\n'
          ...
          'if\n'
          '      the exception occurred kwenye a "try" statement with no matching\n'
          '      tatizo clause ama with a finally clause.\n'
          '\n'
          ...
          'items.\n'
          '         It rudishas a tuple of three integers; respectively these '
          'are\n'
          '         the *start* na *stop* indices na the *step* ama stride\n'
          '         length of the slice. Missing ama out-of-bounds indices are\n'
          '         handled kwenye a manner consistent with regular slices.\n'
          '\n'
          ...
          'the\n'
          '      object actually rudishaed ni the wrapped object, which ni not\n'
 ...
 'typesmapping': 'Mapping Types — "dict"\n'
                 ...
                 'object, a\n'
                 '   dictionary ni created with the same key-value pairs kama '
                 'the mapping\n'
                 ...
                 'then rudishas\n'
                 '      ama ashirias whatever ni rudishaed ama ashiriad by the\n'
                 '      "__missing__(key)" call. No other operations ama '
                 'methods invoke\n'
                 '      "__missing__()". If "__missing__()" ni sio defined, '
                 '"KeyError"\n'
                 '      ni ashiriad. "__missing__()" must be a method; it cannot '
                 'be an\n'
                 '      instance variable:\n'
                 '\n'
                 '         >>> kundi Counter(dict):\n'
                 ...
                 '   key kwenye d\n'
                 '\n'
                 '      Return "Kweli" ikiwa *d* has a key *key*, else "Uongo".\n'
                 '\n'
                 '   key haiko kwenye d\n'
                 '\n'
                 '      Equivalent to "not key kwenye d".\n'
                 '\n'
                 '   iter(d)\n'
                 '\n'
                 ...
                 '\n'
                 '      Create a new dictionary with keys kutoka *iterable* na '
                 'values set\n'
                 '      to *value*.\n'
                 '\n'
                 '      "kutokakeys()" ni a kundi method that rudishas a new '
                 'dictionary.\n'
                 ...
                 '"Tupu", so\n'
                 '      that this method never ashirias a "KeyError".\n'
                 '\n'
                 '   items()\n'
                 '\n'
                 ...
                 'its value,\n'
                 '      else rudisha *default*.  If *default* ni sio given na '
                 '*key* is\n'
                 '      haiko kwenye the dictionary, a "KeyError" ni ashiriad.\n'
                 '\n'
                 '   popitem()\n'
                 '\n'
                 '      Remove na rudisha a "(key, value)" pair kutoka the '
                 'dictionary.\n'
                 '      Pairs are rudishaed kwenye LIFO (last-in, first-out) '
                 'order.\n'
                 '\n'
                 '      "popitem()" ni useful to destructively iterate over a\n'
                 '      dictionary, kama often used kwenye set algorithms.  If the '
                 'dictionary\n'
                 '      ni empty, calling "popitem()" ashirias a "KeyError".\n'
                 '\n'
                 ...
                 'not, insert\n'
                 '      *key* with a value of *default* na rudisha *default*.  '
                 '*default*\n'
                 '      defaults to "Tupu".\n'
                 '\n'
                 '   update([other])\n'
                 ...
                 'dictionary\n'
                 '      ni then updated with those key/value pairs: '
                 '"d.update(red=1,\n'
                 '      blue=2)".\n'
                 '\n'
                 '   values()\n'
                 ...
                 '=======================\n'
                 '\n'
                 'The objects rudishaed by "dict.keys()", "dict.values()" and\n'
                 ...
                 'views are\n'
                 'not treated kama set-like since the entries are generally sio '
                 'unique.)\n'
 ...
 'typesmodules': 'Modules\n'
                 ...
                 'that the\n'
                 '"agiza" statement ni not, strictly speaking, an operation '
                 'on a module\n'
 ...
 'typesseq': 'Sequence Types — "list", "tuple", "range"\n'
             ...
             '\n'
             'The "in" na "not in" operations have the same priorities kama '
             'the\n'
             ...
             'Notes:\n'
             '\n'
             '1. While the "in" na "not in" operations are used only kila '
             'simple\n'
             ...
             'of\n'
             '   items with index *k* such that "i <= k < j".  If *i* ama *j* '
             'is\n'
             ...
             '\n'
             '5. The slice of *s* kutoka *i* to *j* with step *k* ni defined kama '
             'the\n'
             ...
             'depends on\n'
             '   the sign of *k*).  Note, *k* cannot be zero. If *k* ni '
             '"Tupu", it\n'
             '   ni treated like "1".\n'
             '\n'
             ...
             'use\n'
             '     "str.join()" at the end ama else write to an "io.StringIO"\n'
             ...
             '\n'
             '8. "index" ashirias "ValueError" when *x* ni sio found kwenye *s*. '
             'Not\n'
             ...
             'with\n'
             '   the rudishaed index being relative to the start of the '
             'sequence\n'
             ...
             '"s[:]")                 |                       |\n'
             '+--------------------------------+----------------------------------+-----------------------+\n'
             '| "s.extend(t)" ama "s += t"      | extends *s* with the contents '
             'of |                       |\n'
             ...
             'default\n'
             '   the last item ni removed na rudishaed.\n'
             '\n'
             '3. "remove()" ashirias "ValueError" when *x* ni sio found kwenye *s*.\n'
             '\n'
             ...
             '   sequence.\n'
             '\n'
             '5. "clear()" na "copy()" are included kila consistency with the\n'
             ...
             '   rudishaed, similar to "iterable[:]". For example, '
             '"list(\'abc\')"\n'
             '   rudishas "[\'a\', \'b\', \'c\']" na "list( (1, 2, 3) )" '
             'rudishas "[1, 2,\n'
             ...
             'appear\n'
             '      empty kila the duration, na ashirias "ValueError" ikiwa it can '
             'detect\n'
             ...
             '"(a,)"\n'
             '\n'
             '   * Separating items with commas: "a, b, c" ama "(a, b, c)"\n'
             '\n'
             ...
             '   sequence, a container that supports iteration, ama an '
             'iterator\n'
             '   object.  If *iterable* ni already a tuple, it ni rudishaed\n'
             '   unchanged. For example, "tuple(\'abc\')" rudishas "(\'a\', '
             '\'b\', \'c\')"\n'
             '   na "tuple( [1, 2, 3] )" rudishas "(1, 2, 3)". If no argument '
             'is\n'
             ...
             'ambiguity.\n'
             '   For example, "f(a, b, c)" ni a function call with three '
             'arguments,\n'
             '   wakati "f((a, b, c))" ni a function call with a 3-tuple kama the '
             'sole\n'
             '   argument.\n'
             '\n'
             ...
             'If\n'
             '   *step* ni zero, "ValueError" ni ashiriad.\n'
             '\n'
             ...
             'are\n'
             '   permitted but some features (such kama "len()") may ashiria\n'
             '   "OverflowError".\n'
             '\n'
             '   Range examples:\n'
             '\n'
             ...
             '18\n'
             '\n'
             'Testing range objects kila equality with "==" na "!=" compares '
             'them as\n'
 ...
 'typesseq-mutable': 'Mutable Sequence Types\n'
                     ...
                     '"s[:]")                 |                       |\n'
                     '+--------------------------------+----------------------------------+-----------------------+\n'
                     '| "s.extend(t)" ama "s += t"      | extends *s* with the '
                     'contents of |                       |\n'
                     '|                                | *t* (kila the most '
                     'part the same  |                       |\n'
                     '|                                | kama "s[len(s):len(s)] '
                     ...
                     '   the last item ni removed na rudishaed.\n'
                     '\n'
                     '3. "remove()" ashirias "ValueError" when *x* ni sio found '
                     'in *s*.\n'
                     '\n'
 ...
 'unary': 'Unary arithmetic na bitwise operations\n'
          ...
          'a\n'
          '"TypeError" exception ni ashiriad.\n',
 ...
 'with': 'The "with" statement\n'
         ...
         '     method rudishas without an error, then "__exit__()" will always '
         'be\n'
