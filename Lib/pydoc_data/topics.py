...
topics = {'assert': 'The "assert" statement\n'
           ...
           '\n'
           '   ikiwa __debug__:\n'
           '       ikiwa not expression: raise AssertionError\n'
           '\n'
           'The extended form, "assert expression1, expression2", is '
           'equivalent to\n'
           '\n'
           '   ikiwa __debug__:\n'
           '       ikiwa not expression1: raise AssertionError(expression2)\n'
           '\n'
 ...
 'assignment': 'Assignment statements\n'
               ...
               'validity, and\n'
               'may raise an exception ikiwa the assignment is unacceptable.  The '
               'rules\n'
               ...
               '    respectively.\n'
               '\n'
               '  The name is rebound ikiwa it was already bound.  This may cause '
               'the\n'
               ...
               '  assignable attributes; ikiwa this is not the case, "TypeError" '
               'is\n'
               '  raised.  That object is then asked to assign the assigned '
               'object to\n'
               '  the given attribute; ikiwa it cannot perform the assignment, it '
               'raises\n'
               '  an exception (usually but not necessarily '
               '"AttributeError").\n'
               '\n'
               '  Note: If the object is a kundi instance and the attribute '
               'reference\n'
               ...
               'new\n'
               '  key/value pair (ikiwa no key with the same value existed).\n'
               '\n'
               ...
               'about\n'
               'kundi and instance attributes applies as for regular '
               'assignments.\n'
               '\n'
               '\n'
               ...
               'yield_expression)]\n'
               '\n'
               'The difference kutoka normal Assignment statements is that only '
               'single\n'
               'target is allowed.\n'
               '\n'
               'For simple names as assignment targets, ikiwa in kundi or module '
               'scope,\n'
               'the annotations are evaluated and stored in a special kundi or '
               'module\n'
               'attribute "__annotations__" that is a dictionary mapping kutoka '
               'variable\n'
               'names (mangled ikiwa private) to evaluated annotations. This '
               'attribute is\n'
               'writable and is automatically created at the start of kundi or '
               'module\n'
               'body execution, ikiwa annotations are found statically.\n'
               '\n'
               'For expressions as assignment targets, the annotations are '
               'evaluated\n'
               'ikiwa in kundi or module scope, but not stored.\n'
               '\n'
               ...
               'of\n'
               '     variables (including kundi variables and instance '
               'variables),\n'
 ...
 'async': 'Coroutines\n'
          ...
          'functions, even ikiwa they do not contain "await" or "async" '
          'keywords.\n'
          '\n'
          'It is a "SyntaxError" to use a "yield kutoka" expression inside the '
          'body\n'
          ...
          '       BLOCK\n'
          '   except:\n'
          '       ikiwa not await aexit(mgr, *sys.exc_info()):\n'
          '           raise\n'
          '   else:\n'
 ...
 'atom-identifiers': 'Identifiers (Names)\n'
                     ...
                     'textually occurs in\n'
                     'a kundi definition begins with two or more underscore '
                     'characters and\n'
                     ...
                     'inserts the\n'
                     'kundi name, with leading underscores removed and a '
                     'single underscore\n'
                     'inserted, in front of the name.  For example, the '
                     'identifier "__spam"\n'
                     'occurring in a kundi named "Ham" will be transformed to '
                     '"_Ham__spam".\n'
 ...
 'atom-literals': 'Literals\n'
                  ...
                  'the\n'
                  'object’s identity is less agizaant than its value.  '
                  'Multiple\n'
 ...
 'attribute-access': 'Customizing attribute access\n'
                     ...
                     'attribute or an\n'
                     '   attribute in the kundi tree for "self"; or '
                     '"__get__()" of a *name*\n'
                     '   property raises "AttributeError").  This method '
                     'should either\n'
                     '   rudisha the (computed) attribute value or raise an '
                     '"AttributeError"\n'
                     '   exception.\n'
                     '\n'
                     '   Note that ikiwa the attribute is found through the '
                     'normal mechanism,\n'
                     ...
                     'This method\n'
                     '   should rudisha the (computed) attribute value or raise '
                     'an\n'
                     ...
                     'attribute, it\n'
                     '   should call the base kundi method with the same name, '
                     'for example,\n'
                     '   "object.__setattr__(self, name, value)".\n'
                     '\n'
                     ...
                     'instead of\n'
                     '   assignment.  This should only be implemented ikiwa "del '
                     'obj.name" is\n'
                     ...
                     'name of an\n'
                     'attribute and rudisha the computed value or raise an '
                     '"AttributeError".\n'
                     ...
                     'appears in an\n'
                     '*owner* kundi (the descriptor must be in either the '
                     'owner’s class\n'
                     'dictionary or in the kundi dictionary for one of its '
                     'parents).  In the\n'
                     ...
                     'attribute\n'
                     '   access) or of an instance of that kundi (instance '
                     'attribute\n'
                     ...
                     '\n'
                     '   Called at the time the owning kundi *owner* is '
                     'created. The\n'
                     ...
                     '\n'
                     'However, ikiwa the looked-up value is an object defining '
                     'one of the\n'
                     ...
                     '"__set__()" and/or\n'
                     '"__delete__()", it is a data descriptor; ikiwa it defines '
                     'neither, it is\n'
                     ...
                     'variable name.  As a\n'
                     '  result, kundi attributes cannot be used to set default '
                     'values for\n'
                     ...
                     'to the\n'
                     '  kundi where it is defined.  *__slots__* declared in '
                     'parents are\n'
                     ...
                     'slots).\n'
                     '\n'
                     '* If a kundi defines a slot also defined in a base '
                     'class, the\n'
                     '  instance variable defined by the base kundi slot is '
                     'inaccessible\n'
                     '  (except by retrieving its descriptor directly kutoka the '
                     'base class).\n'
 ...
 'binary': 'Binary arithmetic operations\n'
           ...
           'exception.\n'
           '\n'
           'The "%" (modulo) operator yields the remainder kutoka the division '
           'of\n'
 ...
 'bltin-code-objects': 'Code Objects\n'
                       ...
                       'in "compile()" function and can be extracted kutoka '
                       'function objects\n'
 ...
 'booleans': 'Boolean operations\n'
             ...
             '\n'
             'The operator "not" yields "True" ikiwa its argument is false, '
             '"False"\n'
             'otherwise.\n'
             '\n'
             'The expression "x and y" first evaluates *x*; ikiwa *x* is false, '
             'its\n'
             'value is returned; otherwise, *y* is evaluated and the resulting '
             'value\n'
             'is returned.\n'
             '\n'
             'The expression "x or y" first evaluates *x*; ikiwa *x* is true, its '
             'value\n'
             ...
             'they\n'
             'rudisha to "False" and "True", but rather rudisha the last '
             'evaluated\n'
             'argument.  This is sometimes useful, e.g., ikiwa "s" is a string '
             'that\n'
             'should be replaced by a default value ikiwa it is empty, the '
             'expression\n'
 ...
 'break': 'The "break" statement\n'
          ...
          'loop, but not nested in a function or kundi definition within that\n'
          'loop.\n'
          '\n'
 ...
 'callable-types': 'Emulating callable objects\n'
                   ...
                   '\n'
                   '   Called when the instance is “called” as a function; ikiwa '
                   'this method\n'
 ...
 'calls': 'Calls\n'
          ...
          'objects, methods of kundi instances, and all objects having a\n'
          ...
          'corresponding slot (ikiwa the identifier is the same as the first '
          'formal\n'
          'parameter name, the first slot is used, and so on).  If the slot '
          'is\n'
          'already filled, a "TypeError" exception is raised. Otherwise, the\n'
          'value of the argument is placed in the slot, filling it (even ikiwa '
          'the\n'
          ...
          'even\n'
          'ikiwa they are ‘named’ for the purpose of documentation, and which\n'
          ...
          'corresponding values), or a (new) empty dictionary ikiwa there were '
          'no\n'
          ...
          'treated as ikiwa they were additional positional arguments.  For the '
          'call\n'
          ...
          'present (as an explicit keyword argument, or kutoka another '
          'unpacking),\n'
          ...
          '\n'
          'a kundi instance:\n'
          '   The kundi must define a "__call__()" method; the effect is then '
          'the\n'
          '   same as ikiwa that method was called.\n',
 'class': 'Class definitions\n'
          ...
          '\n'
          'A kundi definition is an executable statement.  The inheritance '
          'list\n'
          ...
          'A\n'
          'kundi object is then created using the inheritance list for the '
          'base\n'
          'classes and the saved local namespace for the attribute '
          'dictionary.\n'
          'The kundi name is bound to this kundi object in the original local\n'
          'namespace.\n'
          '\n'
          'The order in which attributes are defined in the kundi body is\n'
          'preserved in the new class’s "__dict__".  Note that this is '
          'reliable\n'
          'only right after the kundi is created and only for classes that '
          'were\n'
          ...
          'for\n'
          'function decorators.  The result is then bound to the kundi name.\n'
          '\n'
          '**Programmer’s note:** Variables defined in the kundi definition '
          'are\n'
          'kundi attributes; they are shared by instances.  Instance '
          'attributes\n'
          'can be set in a method with "self.name = value".  Both kundi and\n'
          'instance attributes are accessible through the notation '
          '“"self.name"”,\n'
          'and an instance attribute hides a kundi attribute with the same '
          'name\n'
          ...
          '     The proposal that added kundi decorators.  Function and '
          'method\n'
 ...
 'comparisons': 'Comparisons\n'
                ...
                'found to be false).\n'
                '\n'
                'Formally, ikiwa *a*, *b*, *c*, …, *y*, *z* are expressions and '
                '*op1*,\n'
                ...
                'not-a-number\n'
                '  values are not equal to themselves.  For example, ikiwa "x =\n'
                ...
                '    "[1,2] < [1,2,3]" is true).\n'
                '\n'
                '* Mappings (instances of "dict") compare equal ikiwa and only ikiwa '
                'they\n'
                ...
                's"\n'
                'evaluates to "True" ikiwa *x* is a member of *s*, and "False" '
                'otherwise.\n'
                ...
                'y)".\n'
                '\n'
                'For the string and bytes types, "x in y" is "True" ikiwa and '
                'only ikiwa *x*\n'
                'is a substring of *y*.  An equivalent test is "y.find(x) != '
                '-1".\n'
                'Empty strings are always considered to be a substring of any '
                'other\n'
                'string, so """ in "abc"" will rudisha "True".\n'
                '\n'
                'For user-defined classes which define the "__contains__()" '
                'method, "x\n'
                'in y" returns "True" ikiwa "y.__contains__(x)" returns a true '
                'value, and\n'
                '"False" otherwise.\n'
                '\n'
                'For user-defined classes which do not define "__contains__()" '
                'but do\n'
                'define "__iter__()", "x in y" is "True" ikiwa some value "z", '
                'for which\n'
                ...
                '\n'
                'Lastly, the old-style iteration protocol is tried: ikiwa a kundi '
                'defines\n'
                '"__getitem__()", "x in y" is "True" ikiwa and only ikiwa there is a '
                'non-\n'
                'negative integer index *i* such that "x is y[i] or x == '
                'y[i]", and no\n'
                'lower integer index raises the "IndexError" exception.  (If '
                'any other\n'
                'exception is raised, it is as ikiwa "in" raised that '
                'exception).\n'
                '\n'
                ...
                'identity: "x is\n'
                'y" is true ikiwa and only ikiwa *x* and *y* are the same object.  '
                'An\n'
 ...
 'compound': 'Compound statements\n'
             ...
             'of\n'
             'code.  Function and kundi definitions are also syntactically '
             'compound\n'
             'statements.\n'
             '\n'
             ...
             '                  ["else" ":" suite]\n'
             '\n'
             'This repeatedly tests the expression and, ikiwa it is true, '
             'executes the\n'
             'first suite; ikiwa the expression is false (which may be the first '
             'time\n'
             'it is tested) the suite of the "else" clause, ikiwa present, is '
             'executed\n'
             ...
             'exception),\n'
             'the suite in the "else" clause, ikiwa present, is executed, and the '
             'loop\n'
             'terminates.\n'
             '\n'
             'A "break" statement executed in the first suite terminates the '
             ...
             'continues\n'
             'with the next item, or with the "else" clause ikiwa there is no '
             'next\n'
             'item.\n'
             '\n'
             ...
             'finished,\n'
             'but ikiwa the sequence is empty, they will not have been assigned '
             'to at\n'
             ...
             'expression-\n'
             'less except clause, ikiwa present, must be last; it matches any\n'
             'exception.  For an except clause with an expression, that '
             'expression\n'
             'is evaluated, and the clause matches the exception ikiwa the '
             'resulting\n'
             'object is “compatible” with the exception.  An object is '
             'compatible\n'
             'with an exception ikiwa it is the kundi or a base kundi of the '
             'exception\n'
             ...
             'and on\n'
             'the call stack (it is treated as ikiwa the entire "try" statement '
             'raised\n'
             'the exception).\n'
             '\n'
             ...
             'statement.\n'
             '(This means that ikiwa two nested handlers exist for the same '
             'exception,\n'
             ...
             '\n'
             'The optional "else" clause is executed ikiwa the control flow '
             'leaves the\n'
             ...
             '\n'
             'The rudisha value of a function is determined by the last '
             '"return"\n'
             ...
             '   value kutoka "__enter__()" is assigned to it.\n'
             '\n'
             ...
             '\n'
             '   If the suite was exited due to an exception, and the rudisha '
             'value\n'
             '   kutoka the "__exit__()" method was false, the exception is '
             'reraised.\n'
             '   If the rudisha value was true, the exception is suppressed, '
             'and\n'
             ...
             'exception, the\n'
             '   rudisha value kutoka "__exit__()" is ignored, and execution '
             'proceeds\n'
             ...
             '*argument* may\n'
             'be omitted kutoka a call, in which case the parameter’s default '
             'value is\n'
             ...
             'as a\n'
             'list or a dictionary: ikiwa the function modifies the object (e.g. '
             'by\n'
             ...
             'function, e.g.:\n'
             '\n'
             '   eleza whats_on_the_telly(penguin=None):\n'
             '       ikiwa penguin is None:\n'
             '           penguin = []\n'
             ...
             'keyword\n'
             'arguments, or kutoka default values.  If the form “"*identifier"” '
             'is\n'
             ...
             'classes and the saved local namespace for the attribute '
             'dictionary.\n'
             'The kundi name is bound to this kundi object in the original '
             'local\n'
             'namespace.\n'
             '\n'
             'The order in which attributes are defined in the kundi body is\n'
             ...
             'as for\n'
             'function decorators.  The result is then bound to the kundi '
             'name.\n'
             '\n'
             '**Programmer’s note:** Variables defined in the kundi definition '
             'are\n'
             'kundi attributes; they are shared by instances.  Instance '
             'attributes\n'
             'can be set in a method with "self.name = value".  Both kundi '
             'and\n'
             'instance attributes are accessible through the notation '
             '“"self.name"”,\n'
             'and an instance attribute hides a kundi attribute with the same '
             ...
             'keywords.\n'
             '\n'
             'It is a "SyntaxError" to use a "yield kutoka" expression inside '
             'the body\n'
             'of a coroutine function.\n'
             '\n'
             'An example of a coroutine function:\n'
 ...
 'context-managers': 'With Statement Context Managers\n'
                     ...
                     'context manager\n'
                     'handles the entry into, and the exit kutoka, the desired '
                     'runtime context\n'
                     ...
                     'target(s)\n'
                     '   specified in the "as" clause of the statement, ikiwa '
                     'any.\n'
                     '\n'
 ...
 'continue': 'The "continue" statement\n'
             ...
             '"while"\n'
             'loop, but not nested in a function or kundi definition within '
             'that\n'
 ...
 'conversions': 'Arithmetic conversions\n'
                ...
                '  complex;\n'
                '\n'
                '* otherwise, ikiwa either argument is a floating point number, '
                'the\n'
 ...
 'customization': 'Basic customization\n'
                  ...
                  'it returns\n'
                  '   an instance or subkundi of *cls*, then the new '
                  'instance’s\n'
                  ...
                  '\n'
                  '   If "__new__()" does not rudisha an instance of *cls*, '
                  'then the new\n'
                  ...
                  'those\n'
                  '   passed to the kundi constructor expression.  If a base '
                  'kundi has an\n'
                  '   "__init__()" method, the derived class’s "__init__()" '
                  'method, if\n'
                  '   any, must explicitly call it to ensure proper '
                  'initialization of the\n'
                  '   base kundi part of the instance; for example:\n'
                  '   "super().__init__([args...])".\n'
                  '\n'
                  ...
                  'begins\n'
                  '       with a single underscore are deleted kutoka their '
                  'module before\n'
                  ...
                  '“informal”\n'
                  '   string representation of instances of that kundi is '
                  'required.\n'
                  '\n'
                  '   This is typically used for debugging, so it is agizaant '
                  'that the\n'
                  ...
                  '"format()" and\n'
                  '   "andika()" to compute the “informal” or nicely printable '
                  'string\n'
                  '   representation of an object.  The rudisha value must be a '
                  'string\n'
                  '   object.\n'
                  '\n'
                  '   This method differs kutoka "object.__repr__()" in that '
                  'there is no\n'
                  ...
                  '"object" itself\n'
                  '   raises a "TypeError" ikiwa passed any non-empty string.\n'
                  '\n'
                  ...
                  '"NotImplemented"\n'
                  '   ikiwa it does not implement the operation for a given pair '
                  'of\n'
                  '   arguments. By convention, "False" and "True" are '
                  'returned for a\n'
                  '   successful comparison. However, these methods can rudisha '
                  'any value,\n'
                  '   so ikiwa the comparison operator is used in a Boolean '
                  'context (e.g.,\n'
                  '   in the condition of an "if" statement), Python will call '
                  '"bool()"\n'
                  '   on the value to determine ikiwa the result is true or '
                  'false.\n'
                  '\n'
                  ...
                  '\n'
                  '   See the paragraph on "__hash__()" for some agizaant '
                  'notes on\n'
                  ...
                  'type is a\n'
                  '   direct or indirect subkundi of the left operand’s type, '
                  'the\n'
                  ...
                  '\n'
                  '   If a kundi does not define an "__eq__()" method it '
                  'should not\n'
                  ...
                  'collections\n'
                  '   requires that a key’s hash value is immutable (ikiwa the '
                  'object’s hash\n'
                  ...
                  'hash(y)".\n'
                  '\n'
                  '   A kundi that overrides "__eq__()" and does not define '
                  '"__hash__()"\n'
                  '   will have its "__hash__()" implicitly set to "None".  '
                  'When the\n'
                  '   "__hash__()" method of a kundi is "None", instances of '
                  'the class\n'
                  ...
                  '\n'
                  '   If a kundi that does not override "__eq__()" wishes to '
                  'suppress\n'
                  ...
                  'operation\n'
                  '   "bool()"; should rudisha "False" or "True".  When this '
                  'method is not\n'
                  '   defined, "__len__()" is called, ikiwa it is defined, and '
                  'the object is\n'
                  '   considered true ikiwa its result is nonzero.  If a kundi '
                  'defines\n'
 ...
 'debugger': '"pdb" — The Python Debugger\n'
             ...
             'executes\n'
             'commands as ikiwa given in a ".pdbrc" file, see Debugger Commands.\n'
             '\n'
             ...
             'module.\n'
             '\n'
             'The typical usage to break into the debugger kutoka a running '
             'program is\n'
             'to insert\n'
             '\n'
             ...
             'useful to\n'
             '   hard-code a breakpoint at a given point in a program, even ikiwa '
             'the\n'
             ...
             'instantiating\n'
             'the "Pdb" kundi and calling the method of the same name.  If you '
             'want\n'
             'to access further features, you have to do this yourself:\n'
             '\n'
             "kundi pdb.Pdb(completekey='tab', stdin=None, stdout=None, "
             ...
             'first\n'
             '";;" pair, even ikiwa it is in the middle of a quoted string.\n'
             '\n'
             'If a file ".pdbrc" exists in the user’s home directory or in '
             'the\n'
             'current directory, it is read in and executed as ikiwa it had been '
             'typed\n'
             ...
             'current\n'
             '   ignore count, and the associated condition ikiwa any.\n'
             '\n'
             ...
             '      (Pdb)\n'
             '\n'
             '   To remove all commands kutoka a breakpoint, type "commands" '
             'and\n'
             ...
             '   arguments, list the given range; ikiwa the second argument is '
             'less\n'
             ...
             'was\n'
             '   originally raised or propagated is indicated by ">>", ikiwa it '
             'differs\n'
             ...
             '   value.\n'
             '\n'
             '   Note: "andika()" can also be used, but is not a debugger '
             'command —\n'
             ...
             'q(uit)\n'
             '\n'
             '   Quit kutoka the debugger.  The program being executed is '
             'aborted.\n'
             '\n'
             '-[ Footnotes ]-\n'
             '\n'
 ...
 'del': 'The "del" statement\n'
        ...
        'kutoka the local namespace ikiwa it occurs as a free variable in a nested\n'
        'block.\n',
 ...
 'exceptions': 'Exceptions\n'
               ...
               'reference the\n'
               'kundi of the instance or a base kundi thereof.  The instance '
               'can be\n'
 ...
 'execmodel': 'Execution model\n'
              ...
              '======================\n'
              '\n'
              'A Python program is constructed kutoka code blocks. A *block* is '
              'a piece\n'
              'of Python program text that is executed as a unit. The '
              'following are\n'
              'blocks: a module, a function body, and a kundi definition. '
              'Each\n'
              ...
              'functions,\n'
              '"agiza" statements, kundi and function definitions (these bind '
              'the\n'
              'kundi or function name in the defining block), and targets that '
              'are\n'
              'identifiers ikiwa occurring in an assignment, "for" loop header, '
              'or after\n'
              '"as" in a "with" statement or "except" clause. The "agiza" '
              'statement\n'
              'of the form "kutoka ... agiza *" binds all names defined in the\n'
              ...
              'name).\n'
              '\n'
              'Each assignment or agiza statement occurs within a block '
              'defined by a\n'
              'kundi or function definition or at the module level (the '
              'top-level\n'
              'code block).\n'
              '\n'
              ...
              '"UnboundLocalError" is a subkundi of "NameError".\n'
              '\n'
              ...
              'scope.\n'
              '"SyntaxError" is raised at compile time ikiwa the given name does '
              'not\n'
              ...
              'are\n'
              'special in the context of name resolution. A kundi definition '
              'is an\n'
              ...
              'dictionary of\n'
              'the class. The scope of names defined in a kundi block is '
              'limited to\n'
              'the kundi block; it does not extend to the code blocks of '
              'methods –\n'
 ...
 'for': 'The "for" statement\n'
        ...
        'executed in the first suite skips the rest of the suite and '
        'continues\n'
        'with the next item, or with the "else" clause ikiwa there is no next\n'
        'item.\n'
        '\n'
        ...
        'but ikiwa the sequence is empty, they will not have been assigned to at\n'
 ...
 'formatstrings': 'Format String Syntax\n'
                  '********************\n'
                  '\n'
                  'The "str.format()" method and the "Formatter" kundi share '
                  'the same\n'
                  ...
                  'positional\n'
                  'argument, and ikiwa it’s a keyword, it refers to a named '
                  'keyword\n'
                  ...
                  'produces\n'
                  'the same result as ikiwa you had called "str()" on the value. '
                  'A non-empty\n'
                  ...
                  'conversions\n'
                  'only ikiwa a digit follows it. In addition, for "\'g\'" and '
                  '"\'G\'"\n'
                  'conversions, trailing zeros are not removed kutoka the '
                  'result.\n'
                  '\n'
                  ...
                  '\n'
                  '   >>> c = 3-5j\n'
                  "   >>> ('The complex number {0} is formed kutoka the real "
                  "part {0.real} '\n"
                  "   ...  'and the imaginary part {0.imag}.').format(c)\n"
                  "   'The complex number (3-5j) is formed kutoka the real part "
 ...
 'global': 'The "global" statement\n'
           ...
           'function definition, "agiza" statement, or variable annotation.\n'
           '\n'
 ...
 'identifiers': 'Identifiers and keywords\n'
                ...
                '   as         eleza        kutoka       nonlocal   while\n'
                '   assert     del        global     not        with\n'
                '   async      elikiwa       ikiwa         or         yield\n'
                '\n'
                '\n'
 ...
 'imaginary': 'Imaginary literals\n'
              ...
              '3.14_15_93j\n',
 'agiza': 'The "agiza" statement\n'
           '**********************\n'
           '\n'
           '   import_stmt     ::= "agiza" module ["as" identifier] ("," '
           'module ["as" identifier])*\n'
           '                   | "kutoka" relative_module "agiza" identifier '
           '["as" identifier]\n'
           '                   ("," identifier ["as" identifier])*\n'
           '                   | "kutoka" relative_module "agiza" "(" '
           'identifier ["as" identifier]\n'
           '                   ("," identifier ["as" identifier])* [","] ")"\n'
           '                   | "kutoka" module "agiza" "*"\n'
           ...
           '\n'
           'The basic agiza statement (no "kutoka" clause) is executed in two\n'
           'steps:\n'
           '\n'
           '1. find a module, loading and initializing it ikiwa necessary\n'
           '\n'
           '2. define a name or names in the local namespace for the scope\n'
           '   where the "agiza" statement occurs.\n'
           '\n'
           ...
           'described in greater detail in the section on the agiza system, '
           'which\n'
           ...
           'the\n'
           'agiza system. Note that failures in this step may indicate '
           'either\n'
           ...
           '\n'
           'The "kutoka" form uses a slightly more complex process:\n'
           '\n'
           '1. find the module specified in the "kutoka" clause, loading and\n'
           '   initializing it ikiwa necessary;\n'
           '\n'
           '2. for each of the identifiers specified in the "agiza" clauses:\n'
           '\n'
           '   1. check ikiwa the imported module has an attribute by that name\n'
           '\n'
           '   2. ikiwa not, attempt to agiza a submodule with that name and '
           'then\n'
           '      check the imported module again for that attribute\n'
           '\n'
           '   3. ikiwa the attribute is not found, "ImportError" is raised.\n'
           '\n'
           '   4. otherwise, a reference to that value is stored in the local\n'
           '      namespace, using the name in the "as" clause ikiwa it is '
           'present,\n'
           ...
           'locally\n'
           '   agiza foo.bar.baz as fbb  # foo.bar.baz imported and bound as '
           'fbb\n'
           '   kutoka foo.bar agiza baz    # foo.bar.baz imported and bound as '
           'baz\n'
           '   kutoka foo agiza attr       # foo imported and foo.attr bound as '
           'attr\n'
           '\n'
           ...
           'the\n'
           'scope where the "agiza" statement occurs.\n'
           '\n'
           'The *public names* defined by a module are determined by checking '
           'the\n'
           'module’s namespace for a variable named "__all__"; ikiwa defined, it '
           'must\n'
           ...
           '\n'
           'The wild card form of agiza — "kutoka module agiza *" — is only\n'
           'allowed at the module level.  Attempting to use it in kundi or\n'
           'function definitions will raise a "SyntaxError".\n'
           '\n'
           'When specifying what module to agiza you do not have to specify '
           'the\n'
           'absolute name of the module. When a module or package is '
           'contained\n'
           'within another package it is possible to make a relative agiza '
           'within\n'
           'the same top package without having to mention the package name. '
           'By\n'
           'using leading dots in the specified module or package after "kutoka" '
           'you\n'
           'can specify how high to traverse up the current package hierarchy\n'
           'without specifying exact names. One leading dot means the current\n'
           'package where the module making the agiza exists. Two dots means '
           'up\n'
           'one package level. Three dots is up two levels, etc. So ikiwa you '
           'execute\n'
           '"kutoka . agiza mod" kutoka a module in the "pkg" package then you '
           'will\n'
           'end up agizaing "pkg.mod". If you execute "kutoka ..subpkg2 agiza '
           'mod"\n'
           'kutoka within "pkg.subpkg1" you will agiza "pkg.subpkg2.mod". The\n'
           'specification for relative agizas is contained in the Package\n'
           ...
           '\n'
           '   future_stmt ::= "kutoka" "__future__" "agiza" feature ["as" '
           'identifier]\n'
           '                   ("," feature ["as" identifier])*\n'
           '                   | "kutoka" "__future__" "agiza" "(" feature '
           '["as" identifier]\n'
           '                   ("," feature ["as" identifier])* [","] ")"\n'
           '   feature     ::= identifier\n'
           '\n'
           ...
           'recognized by Python 3.  The list includes "absolute_agiza",\n'
           ...
           'have\n'
           'been defined, and raises a compile-time error ikiwa a future '
           'statement\n'
           'contains a feature not known to it.\n'
           '\n'
           'The direct runtime semantics are the same as for any agiza '
           'statement:\n'
           ...
           '\n'
           'That is not a future statement; it’s an ordinary agiza statement '
           'with\n'
 ...
 'in': 'Membership test operations\n'
       ...
       'evaluates to "True" ikiwa *x* is a member of *s*, and "False" otherwise.\n'
       '"x not in s" returns the negation of "x in s".  All built-in '
       'sequences\n'
       ...
       'y)".\n'
       '\n'
       'For the string and bytes types, "x in y" is "True" ikiwa and only ikiwa *x*\n'
       'is a substring of *y*.  An equivalent test is "y.find(x) != -1".\n'
       'Empty strings are always considered to be a substring of any other\n'
       'string, so """ in "abc"" will rudisha "True".\n'
       '\n'
       'For user-defined classes which define the "__contains__()" method, "x\n'
       'in y" returns "True" ikiwa "y.__contains__(x)" returns a true value, and\n'
       '"False" otherwise.\n'
       '\n'
       'For user-defined classes which do not define "__contains__()" but do\n'
       'define "__iter__()", "x in y" is "True" ikiwa some value "z", for which\n'
       'the expression "x is z or x == z" is true, is produced while '
       'iterating\n'
       'over "y". If an exception is raised during the iteration, it is as if\n'
       '"in" raised that exception.\n'
       '\n'
       'Lastly, the old-style iteration protocol is tried: ikiwa a kundi defines\n'
       '"__getitem__()", "x in y" is "True" ikiwa and only ikiwa there is a non-\n'
       'negative integer index *i* such that "x is y[i] or x == y[i]", and no\n'
       'lower integer index raises the "IndexError" exception.  (If any other\n'
       'exception is raised, it is as ikiwa "in" raised that exception).\n'
       '\n'
 ...
 'integers': 'Integer literals\n'
             ...
             '\n'
             'There is no limit for the length of integer literals apart kutoka '
             'what\n'
 ...
 'lists': 'List displays\n'
          ...
          'evaluated\n'
          'kutoka left to right and placed into the list object in that order.\n'
          'When a comprehension is supplied, the list is constructed kutoka the\n'
 ...
 'naming': 'Naming and binding\n'
           ...
           'kundi or function name in the defining block), and targets that '
           'are\n'
           'identifiers ikiwa occurring in an assignment, "for" loop header, or '
           'after\n'
           '"as" in a "with" statement or "except" clause. The "agiza" '
           'statement\n'
           'of the form "kutoka ... agiza *" binds all names defined in the\n'
           ...
           'name).\n'
           '\n'
           'Each assignment or agiza statement occurs within a block defined '
           'by a\n'
           'kundi or function definition or at the module level (the '
           'top-level\n'
           'code block).\n'
           ...
           'Class definition blocks and arguments to "exec()" and "eval()" '
           'are\n'
           'special in the context of name resolution. A kundi definition is '
           'an\n'
           'executable statement that may use and define names. These '
           'references\n'
           'follow the normal rules for name resolution with an exception '
           ...
           'of\n'
           'the class. The scope of names defined in a kundi block is limited '
           'to\n'
           'the kundi block; it does not extend to the code blocks of methods '
           '–\n'
 ...
 'nonlocal': 'The "nonlocal" statement\n'
             ...
             'excluding\n'
             'globals. This is agizaant because the default behavior for '
             'binding is\n'
 ...
 'numeric-types': 'Emulating numeric types\n'
                  ...
                  'instance of a\n'
                  '   kundi that has an "__add__()" method, "x.__add__(y)" is '
                  'called.\n'
                  ...
                  'expression "x -\n'
                  '   y", where *y* is an instance of a kundi that has an '
                  '"__rsub__()"\n'
                  '   method, "y.__rsub__(x)" is called ikiwa "x.__sub__(y)" '
                  'returns\n'
                  '   *NotImplemented*.\n'
                  '\n'
                  ...
                  '\n'
                  '   Note: If the right operand’s type is a subkundi of the '
                  'left\n'
                  '     operand’s type and that subkundi provides the '
                  'reflected method\n'
                  ...
                  'attempt to\n'
                  '   do the operation in-place (modifying *self*) and rudisha '
                  'the result\n'
                  '   (which could be, but does not have to be, *self*).  If a '
                  'specific\n'
                  '   method is not defined, the augmented assignment falls '
                  'back to the\n'
                  '   normal methods.  For instance, ikiwa *x* is an instance of '
                  'a class\n'
                  ...
                  'numeric\n'
                  '   object is an integer type.  Must rudisha an integer.\n'
                  '\n'
                  ...
                  '*ndigits* is\n'
                  '   passed to "__round__()" all these methods should rudisha '
                  'the value\n'
 ...
 'objects': 'Objects, values and types\n'
            ...
            'object, its\n'
            'value changes ikiwa that mutable object is changed.\n'
            '\n'
            'Types affect almost all aspects of object behavior.  Even the\n'
            'agizaance of object identity is affected in some sense: for '
            'immutable\n'
 ...
 'pass': 'The "pass" statement\n'
         ...
         '\n'
         '   eleza f(arg): pass    # a function that does nothing (yet)\n'
         '\n'
 ...
 'power': 'The power operator\n'
          ...
          'the\n'
          'operators are evaluated kutoka right to left (this does not '
          'constrain\n'
 ...
 'raise': 'The "raise" statement\n'
          ...
          'object.  It must be either a subkundi or an instance of\n'
          '"BaseException". If it is a class, the exception instance will be\n'
          'obtained when needed by instantiating the kundi with no arguments.\n'
          '\n'
          ...
          '\n'
          'The "kutoka" clause is used for exception chaining: ikiwa given, the '
          'second\n'
          '*expression* must be another exception kundi or instance, which '
          'will\n'
          ...
          '\n'
          'A similar mechanism works implicitly ikiwa an exception is raised '
          'inside\n'
 ...
 'return': 'The "return" statement\n'
           ...
           'The\n'
           'returned value (ikiwa any) is used as an argument to construct\n'
 ...
 'sequence-types': 'Emulating container types\n'
                   ...
                   '0. The\n'
                   '   rudisha value may also be "NotImplemented", which is '
                   'treated the\n'
                   '   same as ikiwa the "__length_hint__" method didn’t exist at '
                   'all. This\n'
                   ...
                   '   raised. For mapping types, ikiwa *key* is missing (not in '
                   'the\n'
                   ...
                   'ikiwa new keys\n'
                   '   can be added, or for sequences ikiwa elements can be '
                   'replaced.  The\n'
                   ...
                   'rudisha true\n'
                   '   ikiwa *item* is in *self*, false otherwise.  For mapping '
                   'objects, this\n'
 ...
 'slicings': 'Slicings\n'
             ...
             'interpretation as a slicing (this is the case ikiwa the slice list\n'
             ...
             'with a\n'
             'key that is constructed kutoka the slice list, as follows.  If the '
             'slice\n'
 ...
 'specialnames': 'Special method names\n'
                 ...
                 'behavior\n'
                 'with respect to language operators.  For instance, ikiwa a '
                 'kundi defines\n'
                 ...
                 'corresponding\n'
                 'operation is not available.  For example, ikiwa a kundi sets '
                 '"__iter__()"\n'
                 'to "None", the kundi is not iterable, so calling "iter()" on '
                 'its\n'
                 ...
                 'it is\n'
                 'agizaant that the emulation only be implemented to the '
                 'degree that it\n'
                 ...
                 '   the same as were passed to the object constructor.\n'
                 '\n'
                 '   If "__new__()" does not rudisha an instance of *cls*, then '
                 'the new\n'
                 '   instance’s "__init__()" method will not be invoked.\n'
                 '\n'
                 '   "__new__()" is intended mainly to allow subclasses of '
                 ...
                 '     "agiza sys; andika(sys.hash_info.width)"".\n'
                 '\n'
                 '   If a kundi does not define an "__eq__()" method it should '
                 'not\n'
                 '   define a "__hash__()" operation either; ikiwa it defines '
                 '"__eq__()"\n'
                 ...
                 '   "bool()"; should rudisha "False" or "True".  When this '
                 'method is not\n'
                 '   defined, "__len__()" is called, ikiwa it is defined, and the '
                 'object is\n'
                 '   considered true ikiwa its result is nonzero.  If a kundi '
                 'defines\n'
                 '   neither "__len__()" nor "__bool__()", all its instances '
                 ...
                 '   "AttributeError" because *name* is not an instance '
                 'attribute or an\n'
                 '   attribute in the kundi tree for "self"; or "__get__()" of '
                 'a *name*\n'
                 ...
                 '   exception.\n'
                 '\n'
                 '   Note that ikiwa the attribute is found through the normal '
                 'mechanism,\n'
                 ...
                 'method\n'
                 '   should rudisha the (computed) attribute value or raise an\n'
                 ...
                 '   If "__setattr__()" wants to assign to an instance '
                 'attribute, it\n'
                 '   should call the base kundi method with the same name, for '
                 'example,\n'
                 '   "object.__setattr__(self, name, value)".\n'
                 '\n'
                 'object.__delattr__(self, name)\n'
                 ...
                 'containing the method (a so-called *descriptor* class) '
                 'appears in an\n'
                 '*owner* kundi (the descriptor must be in either the owner’s '
                 'class\n'
                 'dictionary or in the kundi dictionary for one of its '
                 'parents).  In the\n'
                 'examples below, “the attribute” refers to the attribute '
                 ...
                 '*owner*.\n'
                 '\n'
                 '   This method should rudisha the computed attribute value or '
                 'raise an\n'
                 '   "AttributeError" exception.\n'
                 '\n'
                 ...
                 'object.__set_name__(self, owner, name)\n'
                 '\n'
                 '   Called at the time the owning kundi *owner* is created. '
                 'The\n'
                 '   descriptor has been assigned to *name*.\n'
                 '\n'
                 '   New in version 3.6.\n'
                 ...
                 '"type(a)" excluding metaclasses.\n'
                 '\n'
                 'However, ikiwa the looked-up value is an object defining one of '
                 'the\n'
                 'descriptor methods, then Python may override the default '
                 'behavior and\n'
                 ...
                 'slots).\n'
                 '\n'
                 '* If a kundi defines a slot also defined in a base class, '
                 'the\n'
                 '  instance variable defined by the base kundi slot is '
                 'inaccessible\n'
                 '  (except by retrieving its descriptor directly kutoka the '
                 ...
                 '\n'
                 '   This method is called whenever the containing kundi is '
                 'subclassed.\n'
                 '   *cls* is then the new subclass. If defined as a normal '
                 'instance\n'
                 '   method, this method is implicitly converted to a kundi '
                 'method.\n'
                 '\n'
                 ...
                 'does nothing,\n'
                 '   but raises an error ikiwa it is called with any arguments.\n'
                 '\n'
                 '   Note: The metakundi hint "metaclass" is consumed by the '
                 'rest of\n'
                 ...
                 'kundi body is\n'
                 'executed in a new namespace and the kundi name is bound '
                 'locally to the\n'
                 'result of "type(name, bases, namespace)".\n'
                 '\n'
                 'The kundi creation process can be customized by passing the\n'
                 '"metaclass" keyword argument in the kundi definition line, '
                 'or by\n'
                 ...
                 '       pass\n'
                 '\n'
                 'Any other keyword arguments that are specified in the kundi '
                 'definition\n'
                 'are passed through to all metakundi operations described '
                 'below.\n'
                 '\n'
                 'When a kundi definition is executed, the following steps '
                 'occur:\n'
                 '\n'
                 ...
                 '---------------------\n'
                 '\n'
                 'If a base that appears in kundi definition is not an '
                 'instance of\n'
                 ...
                 '-------------------------------------\n'
                 '\n'
                 'The appropriate metakundi for a kundi definition is '
                 'determined as\n'
                 'follows:\n'
                 '\n'
                 '* ikiwa no bases and no explicit metakundi are given, then '
                 '"type()" is\n'
                 '  used;\n'
                 '\n'
                 '* ikiwa an explicit metakundi is given and it is *not* an '
                 'instance of\n'
                 '  "type()", then it is used directly as the metaclass;\n'
                 '\n'
                 '* ikiwa an instance of "type()" is given as the explicit '
                 'metaclass, or\n'
                 '  bases are defined, then the most derived metakundi is '
                 'used.\n'
                 '\n'
                 'The most derived metakundi is selected kutoka the explicitly '
                 'specified\n'
                 'metakundi (ikiwa any) and the metaclasses (i.e. "type(cls)") of '
                 'all\n'
                 'specified base classes. The most derived metakundi is one '
                 'which is a\n'
                 ...
                 'class\n'
                 'namespace is prepared. If the metakundi has a "__prepare__" '
                 'attribute,\n'
                 ...
                 'the\n'
                 '"__class__" cell is passed to the metakundi as a '
                 '"__classcell__" entry\n'
                 'in the kundi namespace. If present, this must be propagated '
                 'up to the\n'
                 '"type.__new__" call in order for the kundi to be '
                 'initialised\n'
                 'correctly. Failing to do so will result in a "RuntimeError" '
                 'in Python\n'
                 '3.8.\n'
                 '\n'
                 'When using the default metakundi "type", or any metakundi '
                 'that\n'
                 ...
                 'with the\n'
                 '  kundi being defined and the assigned name of that '
                 'particular\n'
                 '  descriptor;\n'
                 '\n'
                 '* finally, the "__init_subclass__()" hook is called on the '
                 'immediate\n'
                 '  parent of the new kundi in its method resolution order.\n'
                 '\n'
                 'After the kundi object is created, it is passed to the '
                 'class\n'
                 'decorators included in the kundi definition (ikiwa any) and the '
                 'resulting\n'
                 'object is bound in the local namespace as the defined '
                 'class.\n'
                 '\n'
                 'When a new kundi is created by "type.__new__", the object '
                 'provided as\n'
                 ...
                 'as\n'
                 '“virtual base classes” to any kundi or type (including '
                 'built-in\n'
                 ...
                 '(metaclass) of a\n'
                 'class.  They cannot be defined as kundi methods in the '
                 'actual class.\n'
                 ...
                 '=======================\n'
                 '\n'
                 'One can implement the generic kundi syntax as specified by '
                 '**PEP 484**\n'
                 ...
                 '\n'
                 'This method is looked up on the kundi object itself, and '
                 'when defined\n'
                 'in the kundi body, this method is implicitly a kundi '
                 'method.  Note,\n'
                 ...
                 '   "__getitem__()".  This should only be implemented for '
                 'mappings if\n'
                 '   the objects support changes to the values for keys, or ikiwa '
                 'new keys\n'
                 '   can be added, or for sequences ikiwa elements can be '
                 'replaced.  The\n'
                 '   same exceptions should be raised for improper *key* '
                 ...
                 '   "__getitem__()".  This should only be implemented for '
                 'mappings if\n'
                 '   the objects support removal of keys, or for sequences ikiwa '
                 'elements\n'
                 '   can be removed kutoka the sequence.  The same exceptions '
                 'should be\n'
                 '   raised for improper *key* values as for the '
                 ...
                 '   Note: If the right operand’s type is a subkundi of the '
                 'left\n'
                 '     operand’s type and that subkundi provides the reflected '
                 'method\n'
                 '     for the operation, this method will be called before '
                 'the left\n'
                 '     operand’s non-reflected method.  This behavior allows '
                 ...
                 '   method is not defined, the augmented assignment falls '
                 'back to the\n'
                 '   normal methods.  For instance, ikiwa *x* is an instance of a '
                 'class\n'
                 ...
                 '   statement will bind this method’s rudisha value to the '
                 'target(s)\n'
                 '   specified in the "as" clause of the statement, ikiwa any.\n'
                 '\n'
                 'object.__exit__(self, exc_type, exc_value, traceback)\n'
                 '\n'
                 '   Exit the runtime context related to this object. The '
                 ...
                 'kundi in this\n'
                 'way is sometimes referred to as ‘metakundi confusion’, and '
                 'is avoided\n'
                 ...
                 'methods (the\n'
                 'special method *must* be set on the kundi object itself in '
                 'order to be\n'
 ...
 'string-methods': 'String Methods\n'
                   ...
                   'space). The\n'
                   '   original string is returned ikiwa *width* is less than or '
                   'equal to\n'
                   '   "len(s)".\n'
                   '\n'
                   ...
                   '\n'
                   '   Return "True" ikiwa the string ends with the specified '
                   '*suffix*,\n'
                   '   otherwise rudisha "False".  *suffix* can also be a tuple '
                   'of suffixes\n'
                   ...
                   'is a newline\n'
                   '   ("\\n") or rudisha ("\\r"), it is copied and the current '
                   'column is\n'
                   ...
                   'need to know\n'
                   '     the position of *sub*.  To check ikiwa *sub* is a '
                   'substring or not,\n'
                   '     use the "in" operator:\n'
                   '\n'
                   "        >>> 'Py' in 'Python'\n"
                   ...
                   '"mapping" is used\n'
                   '   directly and not copied to a "dict".  This is useful ikiwa '
                   'for example\n'
                   ...
                   'str.isalnum()\n'
                   '\n'
                   '   Return true ikiwa all characters in the string are '
                   'alphanumeric and\n'
                   '   there is at least one character, false otherwise.  A '
                   'character "c"\n'
                   '   is alphanumeric ikiwa one of the following returns '
                   '"True":\n'
                   ...
                   'that this is\n'
                   '   different kutoka the “Alphabetic” property defined in the '
                   'Unicode\n'
                   '   Standard.\n'
                   '\n'
                   'str.isascii()\n'
                   '\n'
                   '   Return true ikiwa the string is empty or all characters in '
                   'the string\n'
                   ...
                   'str.isdecimal()\n'
                   '\n'
                   '   Return true ikiwa all characters in the string are decimal '
                   'characters\n'
                   ...
                   'str.isdigit()\n'
                   '\n'
                   '   Return true ikiwa all characters in the string are digits '
                   'and there is\n'
                   ...
                   'str.isidentifier()\n'
                   '\n'
                   '   Return true ikiwa the string is a valid identifier '
                   'according to the\n'
                   ...
                   'str.islower()\n'
                   '\n'
                   '   Return true ikiwa all cased characters [4] in the string '
                   'are lowercase\n'
                   ...
                   'str.isnumeric()\n'
                   '\n'
                   '   Return true ikiwa all characters in the string are numeric '
                   'characters,\n'
                   '   and there is at least one character, false otherwise. '
                   'Numeric\n'
                   ...
                   'str.isspace()\n'
                   '\n'
                   '   Return true ikiwa there are only whitespace characters in '
                   'the string\n'
                   '   and there is at least one character, false otherwise.\n'
                   '\n'
                   '   A character is *whitespace* ikiwa in the Unicode character '
                   'database\n'
                   '   (see "unicodedata"), either its general category is '
                   '"Zs"\n'
                   '   (“Separator, space”), or its bidirectional kundi is one '
                   'of "WS",\n'
                   '   "B", or "S".\n'
                   '\n'
                   'str.istitle()\n'
                   '\n'
                   '   Return true ikiwa the string is a titlecased string and '
                   'there is at\n'
                   ...
                   'is an ASCII\n'
                   '   space). The original string is returned ikiwa *width* is '
                   'less than or\n'
                   '   equal to "len(s)".\n'
                   '\n'
                   'str.lower()\n'
                   ...
                   'empty strings\n'
                   '   at the start or end ikiwa the string has leading or '
                   'trailing\n'
                   ...
                   '\n'
                   '   Return "True" ikiwa string starts with the *prefix*, '
                   'otherwise return\n'
                   ...
                   'characters;\n'
                   '   rudisha "None", to delete the character kutoka the rudisha '
                   'string; or\n'
                   ...
                   '   "False" ikiwa "s" contains uncased characters or ikiwa the '
                   'Unicode\n'
 ...
 'strings': 'String and Bytes literals\n'
            ...
            'by\n'
            'the encoding declaration; it is UTF-8 ikiwa no encoding declaration '
            'is\n'
            ...
            '(This\n'
            'behavior is useful when debugging: ikiwa an escape sequence is '
            'mistyped,\n'
            'the resulting output is more easily recognized as broken.)  It is '
            'also\n'
            'agizaant to note that the escape sequences only recognized in '
            'string\n'
 ...
 'subscriptions': 'Subscriptions\n'
                  ...
                  'corresponds to that\n'
                  'key.  (The expression list is a tuple except ikiwa it has '
                  'exactly one\n'
                  'item.)\n'
                  '\n'
                  ...
                  'item whose\n'
                  'index is that value (counting kutoka zero). Since the support '
                  'for\n'
 ...
 'truth': 'Truth Value Testing\n'
          ...
          '\n'
          'By default, an object is considered true unless its kundi defines\n'
          ...
          'always\n'
          'rudisha "0" or "False" for false and "1" or "True" for true, unless\n'
 ...
 'try': 'The "try" statement\n'
        ...
        'is evaluated, and the clause matches the exception ikiwa the resulting\n'
        ...
        'kutoka a function that handled an exception.\n'
        '\n'
        'The optional "else" clause is executed ikiwa the control flow leaves '
        'the\n'
        ...
        'also executed ‘on the way out.’\n'
        '\n'
        'The rudisha value of a function is determined by the last "return"\n'
 ...
 'types': 'The standard type hierarchy\n'
          ...
          'e.g.,\n'
          '   it is returned kutoka functions that don’t explicitly return\n'
          ...
          '   should rudisha this value ikiwa they do not implement the operation '
          'for\n'
          ...
          '"k"\n'
          '   kutoka the mapping "a"; this can be used in expressions and as '
          'the\n'
          ...
          'numeric\n'
          '      comparison: ikiwa two numbers compare equal (e.g., "1" and '
          '"1.0")\n'
          ...
          '|             |\n'
          '      |                           | or "None" ikiwa no arguments have  '
          '|             |\n'
          '      |                           | a default value.                '
          '|             |\n'
          '      '
          ...
          '\n'
          '      Special read-only attributes: "__self__" is the kundi '
          'instance\n'
          ...
          '      When an instance method object is created by retrieving a '
          'class\n'
          '      method object kutoka a kundi or instance, its "__self__" '
          'attribute\n'
          '      is the kundi itself, and its "__func__" attribute is the\n'
          '      function object underlying the kundi method.\n'
          '\n'
          '      When an instance method object is called, the underlying\n'
          '      function ("__func__") is called, inserting the kundi '
          'instance\n'
          '      ("__self__") in front of the argument list.  For instance, '
          'when\n'
          '      "C" is a kundi which contains a definition for a function '
          '"f()",\n'
          '      and "x" is an instance of "C", calling "x.f(1)" is equivalent '
          'to\n'
          '      calling "C.f(x, 1)".\n'
          '\n'
          '      When an instance method object is derived kutoka a kundi '
          'method\n'
          '      object, the “kundi instance” stored in "__self__" will '
          'actually\n'
          '      be the kundi itself, so that calling either "x.f(1)" or '
          '"C.f(1)"\n'
          ...
          'is\n'
          '      also agizaant to note that user-defined functions which are\n'
          '      attributes of a kundi instance are not converted to bound\n'
          ...
          '      string, or "None" ikiwa unavailable; "__name__" is the '
          'function’s\n'
          '      name; "__self__" is set to "None" (but see the next item);\n'
          '      "__module__" is the name of the module the function was '
          'defined\n'
          '      in or "None" ikiwa unavailable.\n'
          '\n'
          '   Built-in methods\n'
          ...
          '   created by the agiza system as invoked either by the "agiza"\n'
          ...
          '   execution; "__file__" is the pathname of the file kutoka which '
          'the\n'
          ...
          '\n'
          '   When a kundi attribute reference (for kundi "C", say) would '
          'yield a\n'
          '   kundi method object, it is transformed into an instance method\n'
          ...
          'for\n'
          '   another way in which attributes retrieved kutoka a kundi may '
          'differ\n'
          '   kutoka those actually contained in its "__dict__".\n'
          '\n'
          '   Class attribute assignments update the class’s dictionary, '
          'never\n'
          '   the dictionary of a base class.\n'
          '\n'
          '   A kundi object can be called (see above) to yield a kundi '
          'instance\n'
          '   (see below).\n'
          '\n'
          '   Special attributes: "__name__" is the kundi name; "__module__" '
          'is\n'
          '   the module name in which the kundi was defined; "__dict__" is '
          'the\n'
          '   dictionary containing the class’s namespace; "__bases__" is a '
          'tuple\n'
          '   containing the base classes, in the order of their occurrence '
          'in\n'
          '   the base kundi list; "__doc__" is the class’s documentation '
          'string,\n'
          '   or "None" ikiwa undefined; "__annotations__" (optional) is a\n'
          '   dictionary containing *variable annotations* collected during '
          'class\n'
          '   body execution.\n'
          '\n'
          'Class instances\n'
          '   A kundi instance is created by calling a kundi object (see '
          'above).\n'
          '   A kundi instance has a namespace implemented as a dictionary '
          'which\n'
          '   is the first place in which attribute references are searched.\n'
          '   When an attribute is not found there, and the instance’s kundi '
          'has\n'
          '   an attribute by that name, the search continues with the class\n'
          '   attributes.  If a kundi attribute is found that is a '
          'user-defined\n'
          ...
          'differ\n'
          '   kutoka the objects actually stored in the class’s "__dict__".  If '
          'no\n'
          '   kundi attribute is found, and the object’s kundi has a\n'
          ...
          'mappings\n'
          '   ikiwa they have methods with certain special names.  See section\n'
          ...
          'the\n'
          '      bytecode; "co_filename" is the filename kutoka which the code '
          'was\n'
          '      compiled; "co_firstlineno" is the first line number of the\n'
          '      function; "co_lnotab" is a string encoding the mapping kutoka\n'
          ...
          '"0x04"\n'
          '      is set ikiwa the function uses the "*arguments" syntax to accept '
          'an\n'
          '      arbitrary number of positional arguments; bit "0x08" is set '
          'if\n'
          '      the function uses the "**keywords" syntax to accept '
          'arbitrary\n'
          '      keyword arguments; bit "0x20" is set ikiwa the function is a\n'
          '      generator.\n'
          '\n'
          ...
          'is\n'
          '      set ikiwa the function was compiled with future division '
          'enabled;\n'
          ...
          'stack\n'
          '      frame (towards the caller), or "None" ikiwa this is the bottom\n'
          ...
          '\n'
          '      Special writable attributes: "f_trace", ikiwa not "None", is a\n'
          ...
          '\n'
          '         "RuntimeError" is raised ikiwa the frame is currently '
          'executing.\n'
          '\n'
          '         New in version 3.4.\n'
          '\n'
          ...
          'or\n'
          '      "None" ikiwa there is no next level.\n'
          '\n'
          '      Changed in version 3.7: Traceback objects can now be '
          'explicitly\n'
          '      instantiated kutoka Python code, and the "tb_next" attribute '
          'of\n'
          ...
          '      method object is retrieved kutoka a kundi or a kundi instance, '
          'the\n'
          ...
          '      A kundi method object, like a static method object, is a '
          'wrapper\n'
          '      around another object that alters the way in which that '
          'object\n'
          '      is retrieved kutoka classes and kundi instances. The behaviour '
          'of\n'
          '      kundi method objects upon such retrieval is described above,\n'
 ...
 'typesmapping': 'Mapping Types — "dict"\n'
                 ...
                 'keys obey\n'
                 'the normal rules for numeric comparison: ikiwa two numbers '
                 'compare equal\n'
                 ...
                 '   key in d\n'
                 '\n'
                 '      Return "True" ikiwa *d* has a key *key*, else "False".\n'
                 '\n'
                 '   key not in d\n'
                 '\n'
                 ...
                 '\n'
                 '      Create a new dictionary with keys kutoka *iterable* and '
                 'values set\n'
                 '      to *value*.\n'
                 '\n'
                 '      "kutokakeys()" is a kundi method that returns a new '
                 'dictionary.\n'
                 ...
                 '   get(key[, default])\n'
                 '\n'
                 '      Return the value for *key* ikiwa *key* is in the '
                 'dictionary, else\n'
                 ...
                 '   pop(key[, default])\n'
                 '\n'
                 '      If *key* is in the dictionary, remove it and rudisha '
                 'its value,\n'
                 '      else rudisha *default*.  If *default* is not given and '
                 '*key* is\n'
                 '      not in the dictionary, a "KeyError" is raised.\n'
                 '\n'
                 '   popitem()\n'
                 '\n'
                 '      Remove and rudisha a "(key, value)" pair kutoka the '
                 'dictionary.\n'
                 ...
                 '\n'
                 '      If *key* is in the dictionary, rudisha its value.  If '
                 'not, insert\n'
                 '      *key* with a value of *default* and rudisha *default*.  '
                 '*default*\n'
                 '      defaults to "None".\n'
                 '\n'
                 '   update([other])\n'
                 '\n'
                 '      Update the dictionary with the key/value pairs kutoka '
                 '*other*,\n'
                 ...
                 'view and\n'
                 '      another will always rudisha "False". This also applies '
                 'when\n'
                 ...
                 '         False\n'
                 '\n'
                 '   Dictionaries compare equal ikiwa and only ikiwa they have the '
                 'same "(key,\n'
                 ...
                 'x in dictview\n'
                 '\n'
                 '   Return "True" ikiwa *x* is in the underlying dictionary’s '
                 'keys, values\n'
                 ...
                 'abstract\n'
                 'base kundi "collections.abc.Set" are available (for example, '
                 '"==",\n'
                 '"<", or "^").\n'
                 '\n'
 ...
 'typesmethods': 'Methods\n'
                 ...
                 '\n'
                 'If you access a method (a function defined in a kundi '
                 'namespace)\n'
 ...
 'typesmodules': 'Modules\n'
                 ...
                 'that the\n'
                 '"agiza" statement is not, strictly speaking, an operation '
                 'on a module\n'
                 'object; "agiza foo" does not require a module object named '
                 '*foo* to\n'
 ...
 'typesseq': 'Sequence Types — "list", "tuple", "range"\n'
             ...
             '| Notes      |\n'
             '|============================|==================================|============|\n'
             '| "x in s"                   | "True" ikiwa an item of *s* is      '
             '| (1)        |\n'
             '|                            | equal to *x*, else "False"       '
             '|            |\n'
             '+----------------------------+----------------------------------+------------+\n'
             '| "x not in s"               | "False" ikiwa an item of *s* is     '
             '| (1)        |\n'
             ...
             '\n'
             '4. The slice of *s* kutoka *i* to *j* is defined as the sequence '
             'of\n'
             ...
             '\n'
             '5. The slice of *s* kutoka *i* to *j* with step *k* is defined as '
             'the\n'
             ...
             'reduced to\n'
             '   "len(s)" ikiwa they are greater. When *k* is negative, *i* and '
             '*j* are\n'
             '   reduced to "len(s) - 1" ikiwa they are greater.  If *i* or *j* '
             'are\n'
             ...
             '\n'
             '   * ikiwa concatenating "str" objects, you can build a list and '
             'use\n'
             ...
             '\n'
             '   * for other types, investigate the relevant kundi '
             'documentation\n'
             '\n'
             ...
             'users\n'
             '   that it operates by side effect, it does not rudisha the '
             'reversed\n'
             '   sequence.\n'
             '\n'
             ...
             'comparisons\n'
             '      between items. Exceptions are not suppressed - ikiwa any '
             'comparison\n'
             ...
             'to\n'
             '      extract a comparison key kutoka each list element (for '
             'example,\n'
             ...
             'list\n'
             '      elements are sorted as ikiwa each comparison were reversed.\n'
             '\n'
             '      This method modifies the sequence in place for economy of '
             'space\n'
             '      when sorting a large sequence.  To remind users that it '
             'operates\n'
             '      by side effect, it does not rudisha the sorted sequence '
             '(use\n'
             ...
             'is\n'
             '      stable ikiwa it guarantees not to change the relative order '
             'of\n'
             ...
             'appear\n'
             '      empty for the duration, and raises "ValueError" ikiwa it can '
             'detect\n'
             ...
             '\n'
             '   A range object will be empty ikiwa "r[0]" does not meet the '
             'value\n'
             '   constraint. Ranges do support negative indices, but these '
             'are\n'
             '   interpreted as indexing kutoka the end of the sequence '
             'determined by\n'
 ...
 'typesseq-mutable': 'Mutable Sequence Types\n'
                     ...
                     'remind users\n'
                     '   that it operates by side effect, it does not rudisha '
                     'the reversed\n'
                     '   sequence.\n'
                     '\n'
 ...
 'unary': 'Unary arithmetic and bitwise operations\n'
          ...
          '\n'
          'In all three cases, ikiwa the argument does not have the proper type, '
          'a\n'
 ...
 'while': 'The "while" statement\n'
          ...
          '                  ["else" ":" suite]\n'
          '\n'
          'This repeatedly tests the expression and, ikiwa it is true, executes '
          'the\n'
          'first suite; ikiwa the expression is false (which may be the first '
          'time\n'
          'it is tested) the suite of the "else" clause, ikiwa present, is '
 ...
 'with': 'The "with" statement\n'
         ...
         '   kutoka the "__exit__()" method was false, the exception is '
         'reraised.\n'
         '   If the rudisha value was true, the exception is suppressed, and\n'
         '   execution continues with the statement following the "with"\n'
         '   statement.\n'
         '\n'
