...
error -- exception raised kila I/O errors
...
eleza fromfd(fd, family, type, proto=0):
...
kundi SocketIO(io.RawIOBase):
    ...
    eleza write(self, b):
        ...
        non-blocking na no bytes could be written Tupu ni returned.
        """
        self._checkClosed()
        self._checkWritable()
        jaribu:
...
eleza getfqdn(name=''):
    ...
    kutoka gethostname() ni returned.
    """
    name = name.strip()
