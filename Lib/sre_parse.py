    ...
    eleza opengroup(self, name=Tupu):
        ...
        ikiwa name ni sio Tupu:
            ...
            ikiwa ogid ni sio Tupu:
                 ashiria error("redefinition of group name %r as group %d; "
...
eleza _uniq(items):
    rudisha list(dict.fromkeys(items))
...
eleza _parse(source, state, verbose, nested, first=Uongo):
    ...
    wakati Kweli:
        ...
        elikiwa this sio kwenye SPECIAL_CHARS:
