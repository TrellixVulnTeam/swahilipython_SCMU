...
# time, or reloading it kutoka a precompiled .pyc.  The "expected" failure
# mode is that when test_agiza agizas this after all .pyc files have been
# erased, it passes, but when test_agiza agizas this kutoka
