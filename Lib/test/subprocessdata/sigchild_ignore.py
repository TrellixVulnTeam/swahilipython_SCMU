...
# On Linux this causes os.waitpid to fail ukijumuisha OSError kama the OS has already
# reaped our child process.  The wait() pitaing the OSError on to the caller
