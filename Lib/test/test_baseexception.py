    ...
    eleza test_inheritance(self):
        ...
        try:
            ...
            try:
                ...
                self.fail("base kundi %s not a built-in" % superclass_name)
            ...
            for exc_line in inheritance_tree:
                ...
                "%s is not a subkundi of %s" % (exc.__name__,
...
kundi UsageTests(unittest.TestCase):
    ...
    eleza test_raise_new_style_non_exception(self):
        # You cannot raise a new-style kundi that does not inherit kutoka
    ...
    eleza test_catch_non_BaseException(self):
        # Trying to catch an object that does not inherit kutoka BaseException
        # is not allowed.
