...
class CmdLineTest(unittest.TestCase):
    ...
    def test_xoptions(self):
        def get_xoptions(*args):
            ...
            args += ('-c', 'agiza sys; print(sys._xoptions)')
    ...
    def test_showrefcount(self):
        def run_python(*args):
            ...
            return rc, out, err
        code = 'agiza sys; print(sys._xoptions)'
    ...
    def test_osx_android_utf8(self):
        def check_output(text):
            ...
            p = subprocess.Popen(
                (sys.executable, "-c", "agiza sys; print(ascii(sys.argv[1]))", text),
    ...
    def test_stdin_readline(self):
        ...
        self.check_input(
            "agiza sys; print(repr(sys.stdin.readline()))",
            b"'abc\\n'")
    ...
    def test_hash_randomization(self):
        ...
        code = 'agiza sys; print("random is", sys.flags.hash_randomization)'
    ...
    def test_xdev(self):
        # sys.flags.dev_mode
        code = "agiza sys; print(sys.flags.dev_mode)"
        ...
        try:
            ...
            code = "agiza _testcapi; print(_testcapi.pymem_getallocatorsname())"
