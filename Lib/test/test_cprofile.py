...
# rip off all interesting stuff kutoka test_profile
agiza cProfile
kutoka test.test_profile agiza ProfileTest, regenerate_expected_output
...
kundi CProfileTest(ProfileTest):
    ...
    eleza test_profile_as_context_manager(self):
        ...
        ukijumuisha prof kama __enter__return_value:
