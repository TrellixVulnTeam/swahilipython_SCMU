...
order (MRO) for bases """
    ...
    def test_specials(self):
        ...
        # depending on whether this test is run standalone or kutoka a framework.
...
class MiscTests(unittest.TestCase):
    def test_type_lookup_mro_reference(self):
        ...
        # mykey is read kutoka Base
        self.assertEqual(X.mykey, 'kutoka Base')
        # mykey2 is read kutoka Base2 because MyKey.__eq__ has set __bases__
