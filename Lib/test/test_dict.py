...
kundi DictTest(unittest.TestCase):
    ...
    eleza test_fromkeys(self):
        self.assertEqual(dict.fromkeys('abc'), {'a':Tupu, 'b':Tupu, 'c':Tupu})
        d = {}
    ...
    eleza test_missing(self):
        ...
        e = E()
        ukijumuisha self.assertRaises(RuntimeError) as c:
            e[42]
        ...
        f = F()
        ukijumuisha self.assertRaises(KeyError) as c:
            f[42]
        self.assertEqual(c.exception.args, (42,))
    ...
    eleza test_itemiterator_pickling(self):
        kila proto kwenye range(pickle.HIGHEST_PROTOCOL + 1):
            ...
            # ni sio necessarily the same as the original.  It is
    ...
    eleza test_fromkeys_operator_modifying_dict_operand(self):
    ...
    eleza test_fromkeys_operator_modifying_set_operand(self):
