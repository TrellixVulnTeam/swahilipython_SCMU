...
examples ni returned.  (This lets `DocTestRunner` collect statistics
...
'float.hex', na 'int.bit_length' are methods; 'float.fromhex' ni a classmethod,
and 'int' ni a type.
"""
...
given DocTest case kwenye a given namespace (globs).  It returns a tuple
...
debugging):
    ...
    >>> doctest.testfile('test_doctest.txt', raise_on_error=Kweli)
    ... # doctest: +ELLIPSIS
    Traceback (most recent call last):
