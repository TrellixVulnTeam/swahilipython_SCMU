...
class ParentModuleTests:
    ...
    def test_raising_parent_after_agizaing_child(self):
        def __init__():
            agiza pkg.module
            1/0
    ...
    def test_raising_parent_after_relative_agizaing_child(self):
        def __init__():
            kutoka . agiza module
            1/0
        mock = util.mock_spec('pkg.__init__', 'pkg.module',
    ...
    def test_raising_parent_after_double_relative_agizaing_child(self):
        def __init__():
