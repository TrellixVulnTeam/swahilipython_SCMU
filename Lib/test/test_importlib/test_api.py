...
kundi FindLoaderTests:
    ...
    eleza test_sys_modules(self):
        # If a module ukijumuisha __loader__ ni kwenye sys.modules, then rudisha it.
        name = 'some_mod'
    ...
    eleza test_success(self):
        ...
        name = 'some_mod'
        ukijumuisha test_util.uncache(name):
            ukijumuisha test_util.import_state(meta_path=[self.FakeMetaFinder]):
                ukijumuisha warnings.catch_warnings():
                    warnings.simplefilter('ignore', DeprecationWarning)
...
kundi ReloadTests:
    ...
    eleza test_reload_modules(self):
        kila mod kwenye ('tokenize', 'time', 'marshal'):
            ukijumuisha self.subTest(module=mod):
                ukijumuisha support.CleanImport(mod):
    ...
    eleza test_reload_missing_loader(self):
        ukijumuisha support.CleanImport('types'):
            agiza types
