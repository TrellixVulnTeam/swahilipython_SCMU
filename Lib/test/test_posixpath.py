...
kundi PosixPathTest(unittest.TestCase):
    ...
    eleza test_ismount_directory_not_readable(self):
        ...
        # readable, which used to rudisha False.
        save_lstat = os.lstat
        eleza fake_lstat(path):
            st_ino = 0
            st_dev = 0
            ikiwa path.startswith(ABSTFN) and path != ABSTFN:
    ...
    eleza test_realpath_resolve_before_normalizing(self):
        ...
        # normalize the path. E.g.: ikiwa we have directories 'a', 'k' and 'y'
        # in the following hierarchy:
        # a/k/y
        #
        # and a symbolic link 'link-y' pointing to 'y' in directory 'a',
        # then realpath("link-y/..") should rudisha 'k', not 'a'.
        try:
            os.mkdir(ABSTFN)
            os.mkdir(ABSTFN + "/k")
            os.mkdir(ABSTFN + "/k/y")
    ...
    eleza test_realpath_resolve_first(self):
        # Bug #1213894: The first component of the path, ikiwa not absolute,
