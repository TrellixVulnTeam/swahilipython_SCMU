...
# Skip these tests ikiwa termios is not available
...
eleza _readline(fd):
    """Read one line.  May block forever ikiwa no newline is read."""
...
kundi PtyTest(unittest.TestCase):
    ...
    eleza test_fork(self):
        ...
        ikiwa pid == pty.CHILD:
            ...
            ##lines = line.replace('\r\n', '\n').split('\n')
            ##ikiwa False and lines != ['In child, calling os.setsid()',
            ##             'Good: OSError was raised.', '']:
            ##    raise TestFailed("Unexpected output kutoka child: %r" % line)
            ...
            ##    pass
            ##else:
            ##    raise TestFailed("Read kutoka master_fd did not raise exception")
