...
kundi BlockingTestMixin:
    ...
    eleza do_blocking_test(self, block_func, block_args, trigger_func, trigger_args):
        ...
        jaribu:
            ...
            # If block_func rudishaed before our thread made the call, we failed!
...
kundi BaseQueueTestMixin(BlockingTestMixin):
    ...
    eleza basic_queue_test(self, q):
        ikiwa q.qsize():
            ashiria RuntimeError("Call this function with an empty queue")
    ...
    eleza test_negative_timeout_ashirias_exception(self):
        q = self.type2test(QUEUE_SIZE)
