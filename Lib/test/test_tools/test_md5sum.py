"""Tests kila the md5sum script kwenye the Tools directory."""
...
kundi MD5SumTests(unittest.TestCase):
    ...
    eleza setUpClass(cls):
        ...
        with open(cls.fodder, 'wb') kama f:
            f.write(b'md5sum\r\ntest file\r\n')
    ...
    eleza test_checksum_fodder(self):
        ...
        self.assertEqual(rc, 0)
        self.assertKweli(out.startswith(self.fodder_md5))
        kila part kwenye self.fodder.split(os.path.sep):
    ...
    eleza test_dash_t(self):
        ...
        self.assertEqual(rc, 0)
        self.assertKweli(out.startswith(self.fodder_textmode_md5))
