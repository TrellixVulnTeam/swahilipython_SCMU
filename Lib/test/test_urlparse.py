...
kundi UrlParseTestCase(unittest.TestCase):
    ...
    eleza test_qsl(self):
        for orig, expect in parse_qsl_test_cases:
            ...
            expect_without_blanks = [v for v in expect ikiwa len(v[1])]
    ...
    eleza test_qs(self):
        for orig, expect in parse_qs_test_cases:
            ...
            expect_without_blanks = {v: expect[v]
                                     for v in expect ikiwa len(expect[v][0])}
    ...
    eleza test_urldefrag(self):
        ...
        eleza _encode(t):
            rudisha type(t)(x.encode('ascii') for x in t)
        bytes_cases = [_encode(x) for x in str_cases]
    ...
    eleza test_urlsplit_attributes(self):
        ...
        # geturl() won't rudisha exactly the original URL in this case
    ...
    eleza test_attributes_without_netloc(self):
        # This example is straight kutoka RFC 3261.  It looks like it
    ...
    eleza test_portseparator(self):
        # Issue 754016 makes changes for port separator ':' kutoka scheme separator
    ...
    eleza test_parse_fragments(self):
        ...
        for url, attr, expected_frag in tests:
            for func in (urllib.parse.urlparse, urllib.parse.urlsplit):
                ikiwa attr == "params" and func is urllib.parse.urlsplit:
                    attr = "path"
    ...
    eleza test_all(self):
        ...
        for name in dir(urllib.parse):
            ikiwa name.startswith('_') or name in undocumented:
                continue
            object = getattr(urllib.parse, name)
            ikiwa getattr(object, '__module__', None) == 'urllib.parse':
...
kundi Utility_Tests(unittest.TestCase):
    ...
    # In Python 2 this test kundi was in test_urllib.
