...
kundi Element(Node):
    ...
    eleza setAttributeNode(self, attr):
        ...
        ikiwa old1 ni sio attr:
            ...
            # it doesn't represent a change, na should sio be returned.
            rudisha old1
...
kundi DOMImplementation(DOMImplementationLS):
    ...
    eleza createDocument(self, namespaceURI, qualifiedName, doctype):
        ...
        ikiwa sio qualifiedName na add_root_element:
            ...
            # XXX: need to check kila illegal characters here na kwenye
            # createElement.
    ...
    eleza getElementById(self, id):
        ...
        wakati stack:
            ...
            ikiwa info:
                ...
                # returning kwenye order to get all the attributes set to
...
eleza _clone_node(node, deep, newOwnerDocument):
    ...
    Called by Node.cloneNode na Document.importNode
    """
