...
kundi SAXException(Exception):
    ...
    ErrorHandler interface, you are sio actually required to ashiria
...
kundi SAXParseException(SAXException):
    ...
    eleza __init__(self, msg, exception, locator):
        ...
        # If this exception ni ashiriad, the objects through which we must
...
kundi SAXReaderNotAvailable(SAXNotSupportedException):
    ...
    It also may be ashiriad during parsing, e.g. ikiwa executing an external
