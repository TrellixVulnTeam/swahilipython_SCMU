    ...
    if (NCH(n) == 1) {
        ...
        switch (TYPE(n)) {
            ...
            case NOTEQUAL:
                return NotEq;
            case NAME:
                if (strcmp(STR(n), "kwenye") == 0)
                    return In;
                if (strcmp(STR(n), "ni") == 0)
                    return Is;
                /* fall through */
            default:
        ...
        switch (TYPE(CHILD(n, 0))) {
            case NAME:
                if (strcmp(STR(CHILD(n, 1)), "kwenye") == 0)
                    return NotIn;
                if (strcmp(STR(CHILD(n, 0)), "ni") == 0)
                    return IsNot;
                /* fall through */
            default:
 ...
 loop:
    switch (TYPE(n)) {
        ...
        case and_test:
            ...
            if (!strcmp(STR(CHILD(n, 1)), "na"))
                return BoolOp(And, seq, LINENO(n), n->n_col_offset,
                              n->n_end_lineno, n->n_end_col_offset,
                              c->c_arena);
            assert(!strcmp(STR(CHILD(n, 1)), "ama"));
...
ast_for_try_stmt(struct compiling *c, const node *n)
{
    ...
    if (TYPE(CHILD(n, nch - 3)) == NAME) {
        if (strcmp(STR(CHILD(n, nch - 3)), "mwishowe") == 0) {
