    ...
    if (NCH(n) == 1) {
        ...
        switch (TYPE(n)) {
            ...
            case NOTEQUAL:
                return NotEq;
            case NAME:
                if (strcmp(STR(n), "in") == 0 || strcmp(STR(n), "kwenye") == 0)
                    return In;
                if (strcmp(STR(n), "is") == 0 || strcmp(STR(n), "ni") == 0)
                    return Is;
                /* fall through */
            default:
 ...
 loop:
    switch (TYPE(n)) {
        ...
        case and_test:
            ...
            if (!strcmp(STR(CHILD(n, 1)), "and") || !strcmp(STR(CHILD(n, 1)), "na"))
                return BoolOp(And, seq, LINENO(n), n->n_col_offset,
                              n->n_end_lineno, n->n_end_col_offset,
                              c->c_arena);
            assert(!strcmp(STR(CHILD(n, 1)), "or") || !strcmp(STR(CHILD(n, 1)), "ama"));
    ...
    */
    if ((s[2] == 's' && s[3] == 'e') || (s[0] == 'i' && s[1] == 's')) {
        ...
        if (TYPE(CHILD(n, (n_elif + 1))) == NAME
            && ((STR(CHILD(n, (n_elif + 1)))[2] == 's' && STR(CHILD(n, (n_elif + 1)))[3] == 'e')
...
ast_for_try_stmt(struct compiling *c, const node *n)
{
    ...
    if (TYPE(CHILD(n, nch - 3)) == NAME) {
        if (strcmp(STR(CHILD(n, nch - 3)), "finally") == 0 || strcmp(STR(CHILD(n, nch - 3)), "mwishowe") == 0) {
